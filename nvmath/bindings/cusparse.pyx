...
cpdef intptr_t create() except? 0:
    ...
    cdef Handle handle
    with nogil:
        __status__ = cusparseCreate(&handle)
    check_status(__status__)
...
cpdef destroy(intptr_t handle):
    """See `cusparseDestroy`."""
    with nogil:
        __status__ = cusparseDestroy(<Handle>handle)
    check_status(__status__)
...
cpdef int get_version(intptr_t handle) except? -1:
    ...
    cdef int version
    with nogil:
        __status__ = cusparseGetVersion(<Handle>handle, &version)
    check_status(__status__)
    return version
...
cpdef int get_property(int type) except? -1:
    ...
    cdef int value
    with nogil:
        __status__ = cusparseGetProperty(<LibraryPropertyType>type, &value)
    check_status(__status__)
    return value
...
cpdef set_stream(intptr_t handle, intptr_t stream_id):
    ...
    with nogil:
        __status__ = cusparseSetStream(<Handle>handle, <Stream>stream_id)
    check_status(__status__)
...
cpdef intptr_t get_stream(intptr_t handle) except? 0:
    ...
    with nogil:
        __status__ = cusparseGetStream(<Handle>handle, &stream_id)
    check_status(__status__)
...
cpdef int get_pointer_mode(intptr_t handle) except? -1:
    ...
    with nogil:
        __status__ = cusparseGetPointerMode(<Handle>handle, &mode)
    check_status(__status__)
    return <int>mode
...
cpdef set_pointer_mode(intptr_t handle, int mode):
    ...
    with nogil:
        __status__ = cusparseSetPointerMode(<Handle>handle, <_PointerMode>mode)
    check_status(__status__)
...
cpdef logger_open_file(log_file):
    ...
    with nogil:
        __status__ = cusparseLoggerOpenFile(<const char*>_log_file_)
    check_status(__status__)
...
cpdef logger_set_level(int level):
    ...
    with nogil:
        __status__ = cusparseLoggerSetLevel(level)
    check_status(__status__)
...
cpdef logger_set_mask(int mask):
    ...
    with nogil:
        __status__ = cusparseLoggerSetMask(mask)
    check_status(__status__)
...
cpdef logger_force_disable():
    ...
    with nogil:
        __status__ = cusparseLoggerForceDisable()
    check_status(__status__)
...
cpdef intptr_t create_mat_descr() except? 0:
    ...
    with nogil:
        __status__ = cusparseCreateMatDescr(&descr_a)
    check_status(__status__)
...
cpdef destroy_mat_descr(intptr_t descr_a):
    ...
    with nogil:
        __status__ = cusparseDestroyMatDescr(<MatDescr>descr_a)
    check_status(__status__)
...
cpdef set_mat_type(intptr_t descr_a, int type):
    ...
    with nogil:
        __status__ = cusparseSetMatType(<MatDescr>descr_a, <_MatrixType>type)
    check_status(__status__)
...
cpdef set_mat_fill_mode(intptr_t descr_a, int fill_mode):
    ...
    with nogil:
        __status__ = cusparseSetMatFillMode(<MatDescr>descr_a, <_FillMode>fill_mode)
    check_status(__status__)
...
cpdef set_mat_diag_type(intptr_t descr_a, int diag_type):
    ...
    with nogil:
        __status__ = cusparseSetMatDiagType(<MatDescr>descr_a, <_DiagType>diag_type)
    check_status(__status__)
...
cpdef set_mat_index_base(intptr_t descr_a, int base):
    ...
    with nogil:
        __status__ = cusparseSetMatIndexBase(<MatDescr>descr_a, <_IndexBase>base)
    check_status(__status__)
...
cpdef sgemvi(intptr_t handle, int trans_a, int m, int n, intptr_t alpha, intptr_t a, int lda, int nnz, intptr_t x_val, intptr_t x_ind, intptr_t beta, intptr_t y, int idx_base, intptr_t p_buffer):
    """See `cusparseSgemvi`."""
    with nogil:
        __status__ = cusparseSgemvi(<Handle>handle, <_Operation>trans_a, m, n, <const float*>alpha, <const float*>a, lda, nnz, <const float*>x_val, <const int*>x_ind, <const float*>beta, <float*>y, <_IndexBase>idx_base, <void*>p_buffer)
    check_status(__status__)
...
cpdef int sgemvi_buffer_size(intptr_t handle, int trans_a, int m, int n, int nnz) except? -1:
    ...
    with nogil:
        __status__ = cusparseSgemvi_bufferSize(<Handle>handle, <_Operation>trans_a, m, n, nnz, &p_buffer_size)
    check_status(__status__)
...
cpdef dgemvi(intptr_t handle, int trans_a, int m, int n, intptr_t alpha, intptr_t a, int lda, int nnz, intptr_t x_val, intptr_t x_ind, intptr_t beta, intptr_t y, int idx_base, intptr_t p_buffer):
    """See `cusparseDgemvi`."""
    with nogil:
        __status__ = cusparseDgemvi(<Handle>handle, <_Operation>trans_a, m, n, <const double*>alpha, <const double*>a, lda, nnz, <const double*>x_val, <const int*>x_ind, <const double*>beta, <double*>y, <_IndexBase>idx_base, <void*>p_buffer)
    check_status(__status__)
...
cpdef int dgemvi_buffer_size(intptr_t handle, int trans_a, int m, int n, int nnz) except? -1:
    ...
    cdef int p_buffer_size
    with nogil:
        __status__ = cusparseDgemvi_bufferSize(<Handle>handle, <_Operation>trans_a, m, n, nnz, &p_buffer_size)
    check_status(__status__)
    return p_buffer_size
...
cpdef cgemvi(intptr_t handle, int trans_a, int m, int n, intptr_t alpha, intptr_t a, int lda, int nnz, intptr_t x_val, intptr_t x_ind, intptr_t beta, intptr_t y, int idx_base, intptr_t p_buffer):
    """See `cusparseCgemvi`."""
    with nogil:
        __status__ = cusparseCgemvi(<Handle>handle, <_Operation>trans_a, m, n, <const cuComplex*>alpha, <const cuComplex*>a, lda, nnz, <const cuComplex*>x_val, <const int*>x_ind, <const cuComplex*>beta, <cuComplex*>y, <_IndexBase>idx_base, <void*>p_buffer)
    check_status(__status__)
...
cpdef int cgemvi_buffer_size(intptr_t handle, int trans_a, int m, int n, int nnz) except? -1:
    ...
    cdef int p_buffer_size
    with nogil:
        __status__ = cusparseCgemvi_bufferSize(<Handle>handle, <_Operation>trans_a, m, n, nnz, &p_buffer_size)
    check_status(__status__)
    return p_buffer_size
...
cpdef zgemvi(intptr_t handle, int trans_a, int m, int n, intptr_t alpha, intptr_t a, int lda, int nnz, intptr_t x_val, intptr_t x_ind, intptr_t beta, intptr_t y, int idx_base, intptr_t p_buffer):
    """See `cusparseZgemvi`."""
    with nogil:
        __status__ = cusparseZgemvi(<Handle>handle, <_Operation>trans_a, m, n, <const cuDoubleComplex*>alpha, <const cuDoubleComplex*>a, lda, nnz, <const cuDoubleComplex*>x_val, <const int*>x_ind, <const cuDoubleComplex*>beta, <cuDoubleComplex*>y, <_IndexBase>idx_base, <void*>p_buffer)
    check_status(__status__)
...
cpdef int zgemvi_buffer_size(intptr_t handle, int trans_a, int m, int n, int nnz) except? -1:
    ...
    cdef int p_buffer_size
    with nogil:
        __status__ = cusparseZgemvi_bufferSize(<Handle>handle, <_Operation>trans_a, m, n, nnz, &p_buffer_size)
    check_status(__status__)
    return p_buffer_size
...
cpdef sbsrmv(intptr_t handle, int dir_a, int trans_a, int mb, int nb, int nnzb, intptr_t alpha, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int block_dim, intptr_t x, intptr_t beta, intptr_t y):
    """See `cusparseSbsrmv`."""
    with nogil:
        __status__ = cusparseSbsrmv(<Handle>handle, <_Direction>dir_a, <_Operation>trans_a, mb, nb, nnzb, <const float*>alpha, <const MatDescr>descr_a, <const float*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, block_dim, <const float*>x, <const float*>beta, <float*>y)
    check_status(__status__)
...
cpdef dbsrmv(intptr_t handle, int dir_a, int trans_a, int mb, int nb, int nnzb, intptr_t alpha, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int block_dim, intptr_t x, intptr_t beta, intptr_t y):
    """See `cusparseDbsrmv`."""
    with nogil:
        __status__ = cusparseDbsrmv(<Handle>handle, <_Direction>dir_a, <_Operation>trans_a, mb, nb, nnzb, <const double*>alpha, <const MatDescr>descr_a, <const double*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, block_dim, <const double*>x, <const double*>beta, <double*>y)
    check_status(__status__)
...
cpdef cbsrmv(intptr_t handle, int dir_a, int trans_a, int mb, int nb, int nnzb, intptr_t alpha, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int block_dim, intptr_t x, intptr_t beta, intptr_t y):
    """See `cusparseCbsrmv`."""
    with nogil:
        __status__ = cusparseCbsrmv(<Handle>handle, <_Direction>dir_a, <_Operation>trans_a, mb, nb, nnzb, <const cuComplex*>alpha, <const MatDescr>descr_a, <const cuComplex*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, block_dim, <const cuComplex*>x, <const cuComplex*>beta, <cuComplex*>y)
    check_status(__status__)
...
cpdef zbsrmv(intptr_t handle, int dir_a, int trans_a, int mb, int nb, int nnzb, intptr_t alpha, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int block_dim, intptr_t x, intptr_t beta, intptr_t y):
    """See `cusparseZbsrmv`."""
    with nogil:
        __status__ = cusparseZbsrmv(<Handle>handle, <_Direction>dir_a, <_Operation>trans_a, mb, nb, nnzb, <const cuDoubleComplex*>alpha, <const MatDescr>descr_a, <const cuDoubleComplex*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, block_dim, <const cuDoubleComplex*>x, <const cuDoubleComplex*>beta, <cuDoubleComplex*>y)
    check_status(__status__)
...
cpdef sbsrmm(intptr_t handle, int dir_a, int trans_a, int trans_b, int mb, int n, int kb, int nnzb, intptr_t alpha, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int block_size, intptr_t b, int ldb, intptr_t beta, intptr_t c, int ldc):
    """See `cusparseSbsrmm`."""
    with nogil:
        __status__ = cusparseSbsrmm(<Handle>handle, <_Direction>dir_a, <_Operation>trans_a, <_Operation>trans_b, mb, n, kb, nnzb, <const float*>alpha, <const MatDescr>descr_a, <const float*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, <const int>block_size, <const float*>b, <const int>ldb, <const float*>beta, <float*>c, ldc)
    check_status(__status__)
...
cpdef dbsrmm(intptr_t handle, int dir_a, int trans_a, int trans_b, int mb, int n, int kb, int nnzb, intptr_t alpha, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int block_size, intptr_t b, int ldb, intptr_t beta, intptr_t c, int ldc):
    """See `cusparseDbsrmm`."""
    with nogil:
        __status__ = cusparseDbsrmm(<Handle>handle, <_Direction>dir_a, <_Operation>trans_a, <_Operation>trans_b, mb, n, kb, nnzb, <const double*>alpha, <const MatDescr>descr_a, <const double*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, <const int>block_size, <const double*>b, <const int>ldb, <const double*>beta, <double*>c, ldc)
    check_status(__status__)
...
cpdef cbsrmm(intptr_t handle, int dir_a, int trans_a, int trans_b, int mb, int n, int kb, int nnzb, intptr_t alpha, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int block_size, intptr_t b, int ldb, intptr_t beta, intptr_t c, int ldc):
    """See `cusparseCbsrmm`."""
    with nogil:
        __status__ = cusparseCbsrmm(<Handle>handle, <_Direction>dir_a, <_Operation>trans_a, <_Operation>trans_b, mb, n, kb, nnzb, <const cuComplex*>alpha, <const MatDescr>descr_a, <const cuComplex*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, <const int>block_size, <const cuComplex*>b, <const int>ldb, <const cuComplex*>beta, <cuComplex*>c, ldc)
    check_status(__status__)
...
cpdef size_t sgtsv2_buffer_size_ext(intptr_t handle, int m, int n, intptr_t dl, intptr_t d, intptr_t du, intptr_t b, int ldb) except? 0:
    ...
    with nogil:
        __status__ = cusparseSgtsv2_bufferSizeExt(<Handle>handle, m, n, <const float*>dl, <const float*>d, <const float*>du, <const float*>b, ldb, &buffer_size_in_bytes)
    check_status(__status__)
...
cpdef size_t dgtsv2_buffer_size_ext(intptr_t handle, int m, int n, intptr_t dl, intptr_t d, intptr_t du, intptr_t b, int ldb) except? 0:
    ...
    cdef size_t buffer_size_in_bytes
    with nogil:
        __status__ = cusparseDgtsv2_bufferSizeExt(<Handle>handle, m, n, <const double*>dl, <const double*>d, <const double*>du, <const double*>b, ldb, &buffer_size_in_bytes)
    check_status(__status__)
    return buffer_size_in_bytes
...
cpdef size_t cgtsv2_buffer_size_ext(intptr_t handle, int m, int n, intptr_t dl, intptr_t d, intptr_t du, intptr_t b, int ldb) except? 0:
    ...
    cdef size_t buffer_size_in_bytes
    with nogil:
        __status__ = cusparseCgtsv2_bufferSizeExt(<Handle>handle, m, n, <const cuComplex*>dl, <const cuComplex*>d, <const cuComplex*>du, <const cuComplex*>b, ldb, &buffer_size_in_bytes)
    check_status(__status__)
    return buffer_size_in_bytes
...
cpdef size_t zgtsv2_buffer_size_ext(intptr_t handle, int m, int n, intptr_t dl, intptr_t d, intptr_t du, intptr_t b, int ldb) except? 0:
    ...
    cdef size_t buffer_size_in_bytes
    with nogil:
        __status__ = cusparseZgtsv2_bufferSizeExt(<Handle>handle, m, n, <const cuDoubleComplex*>dl, <const cuDoubleComplex*>d, <const cuDoubleComplex*>du, <const cuDoubleComplex*>b, ldb, &buffer_size_in_bytes)
    check_status(__status__)
    return buffer_size_in_bytes
...
cpdef sgtsv2(intptr_t handle, int m, int n, intptr_t dl, intptr_t d, intptr_t du, intptr_t b, int ldb, intptr_t p_buffer):
    """See `cusparseSgtsv2`."""
    with nogil:
        __status__ = cusparseSgtsv2(<Handle>handle, m, n, <const float*>dl, <const float*>d, <const float*>du, <float*>b, ldb, <void*>p_buffer)
    check_status(__status__)
...
cpdef dgtsv2(intptr_t handle, int m, int n, intptr_t dl, intptr_t d, intptr_t du, intptr_t b, int ldb, intptr_t p_buffer):
    """See `cusparseDgtsv2`."""
    with nogil:
        __status__ = cusparseDgtsv2(<Handle>handle, m, n, <const double*>dl, <const double*>d, <const double*>du, <double*>b, ldb, <void*>p_buffer)
    check_status(__status__)
...
cpdef cgtsv2(intptr_t handle, int m, int n, intptr_t dl, intptr_t d, intptr_t du, intptr_t b, int ldb, intptr_t p_buffer):
    """See `cusparseCgtsv2`."""
    with nogil:
        __status__ = cusparseCgtsv2(<Handle>handle, m, n, <const cuComplex*>dl, <const cuComplex*>d, <const cuComplex*>du, <cuComplex*>b, ldb, <void*>p_buffer)
    check_status(__status__)
...
cpdef zgtsv2(intptr_t handle, int m, int n, intptr_t dl, intptr_t d, intptr_t du, intptr_t b, int ldb, intptr_t p_buffer):
    """See `cusparseZgtsv2`."""
    with nogil:
        __status__ = cusparseZgtsv2(<Handle>handle, m, n, <const cuDoubleComplex*>dl, <const cuDoubleComplex*>d, <const cuDoubleComplex*>du, <cuDoubleComplex*>b, ldb, <void*>p_buffer)
    check_status(__status__)
...
cpdef size_t sgtsv2_nopivot_buffer_size_ext(intptr_t handle, int m, int n, intptr_t dl, intptr_t d, intptr_t du, intptr_t b, int ldb) except? 0:
    ...
    cdef size_t buffer_size_in_bytes
    with nogil:
        __status__ = cusparseSgtsv2_nopivot_bufferSizeExt(<Handle>handle, m, n, <const float*>dl, <const float*>d, <const float*>du, <const float*>b, ldb, &buffer_size_in_bytes)
    check_status(__status__)
    return buffer_size_in_bytes
...
cpdef size_t dgtsv2_nopivot_buffer_size_ext(intptr_t handle, int m, int n, intptr_t dl, intptr_t d, intptr_t du, intptr_t b, int ldb) except? 0:
    ...
    cdef size_t buffer_size_in_bytes
    with nogil:
        __status__ = cusparseDgtsv2_nopivot_bufferSizeExt(<Handle>handle, m, n, <const double*>dl, <const double*>d, <const double*>du, <const double*>b, ldb, &buffer_size_in_bytes)
    check_status(__status__)
    return buffer_size_in_bytes
...
cpdef size_t cgtsv2_nopivot_buffer_size_ext(intptr_t handle, int m, int n, intptr_t dl, intptr_t d, intptr_t du, intptr_t b, int ldb) except? 0:
    ...
    cdef size_t buffer_size_in_bytes
    with nogil:
        __status__ = cusparseCgtsv2_nopivot_bufferSizeExt(<Handle>handle, m, n, <const cuComplex*>dl, <const cuComplex*>d, <const cuComplex*>du, <const cuComplex*>b, ldb, &buffer_size_in_bytes)
    check_status(__status__)
    return buffer_size_in_bytes
...
cpdef size_t zgtsv2_nopivot_buffer_size_ext(intptr_t handle, int m, int n, intptr_t dl, intptr_t d, intptr_t du, intptr_t b, int ldb) except? 0:
    ...
    cdef size_t buffer_size_in_bytes
    with nogil:
        __status__ = cusparseZgtsv2_nopivot_bufferSizeExt(<Handle>handle, m, n, <const cuDoubleComplex*>dl, <const cuDoubleComplex*>d, <const cuDoubleComplex*>du, <const cuDoubleComplex*>b, ldb, &buffer_size_in_bytes)
    check_status(__status__)
    return buffer_size_in_bytes
...
cpdef sgtsv2_nopivot(intptr_t handle, int m, int n, intptr_t dl, intptr_t d, intptr_t du, intptr_t b, int ldb, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseSgtsv2_nopivot(<Handle>handle, m, n, <const float*>dl, <const float*>d, <const float*>du, <float*>b, ldb, <void*>p_buffer)
    check_status(__status__)
...
cpdef dgtsv2_nopivot(intptr_t handle, int m, int n, intptr_t dl, intptr_t d, intptr_t du, intptr_t b, int ldb, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseDgtsv2_nopivot(<Handle>handle, m, n, <const double*>dl, <const double*>d, <const double*>du, <double*>b, ldb, <void*>p_buffer)
    check_status(__status__)
...
cpdef cgtsv2_nopivot(intptr_t handle, int m, int n, intptr_t dl, intptr_t d, intptr_t du, intptr_t b, int ldb, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseCgtsv2_nopivot(<Handle>handle, m, n, <const cuComplex*>dl, <const cuComplex*>d, <const cuComplex*>du, <cuComplex*>b, ldb, <void*>p_buffer)
    check_status(__status__)
...
cpdef zgtsv2_nopivot(intptr_t handle, int m, int n, intptr_t dl, intptr_t d, intptr_t du, intptr_t b, int ldb, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseZgtsv2_nopivot(<Handle>handle, m, n, <const cuDoubleComplex*>dl, <const cuDoubleComplex*>d, <const cuDoubleComplex*>du, <cuDoubleComplex*>b, ldb, <void*>p_buffer)
    check_status(__status__)
...
cpdef size_t sgtsv2strided_batch_buffer_size_ext(intptr_t handle, int m, intptr_t dl, intptr_t d, intptr_t du, intptr_t x, int batch_count, int batch_stride) except? 0:
    ...
    cdef size_t buffer_size_in_bytes
    with nogil:
        __status__ = cusparseSgtsv2StridedBatch_bufferSizeExt(<Handle>handle, m, <const float*>dl, <const float*>d, <const float*>du, <const float*>x, batch_count, batch_stride, &buffer_size_in_bytes)
    check_status(__status__)
    return buffer_size_in_bytes
...
cpdef size_t dgtsv2strided_batch_buffer_size_ext(intptr_t handle, int m, intptr_t dl, intptr_t d, intptr_t du, intptr_t x, int batch_count, int batch_stride) except? 0:
    ...
    cdef size_t buffer_size_in_bytes
    with nogil:
        __status__ = cusparseDgtsv2StridedBatch_bufferSizeExt(<Handle>handle, m, <const double*>dl, <const double*>d, <const double*>du, <const double*>x, batch_count, batch_stride, &buffer_size_in_bytes)
    check_status(__status__)
    return buffer_size_in_bytes
...
cpdef size_t cgtsv2strided_batch_buffer_size_ext(intptr_t handle, int m, intptr_t dl, intptr_t d, intptr_t du, intptr_t x, int batch_count, int batch_stride) except? 0:
    ...
    cdef size_t buffer_size_in_bytes
    with nogil:
        __status__ = cusparseCgtsv2StridedBatch_bufferSizeExt(<Handle>handle, m, <const cuComplex*>dl, <const cuComplex*>d, <const cuComplex*>du, <const cuComplex*>x, batch_count, batch_stride, &buffer_size_in_bytes)
    check_status(__status__)
    return buffer_size_in_bytes
...
cpdef size_t zgtsv2strided_batch_buffer_size_ext(intptr_t handle, int m, intptr_t dl, intptr_t d, intptr_t du, intptr_t x, int batch_count, int batch_stride) except? 0:
    ...
    cdef size_t buffer_size_in_bytes
    with nogil:
        __status__ = cusparseZgtsv2StridedBatch_bufferSizeExt(<Handle>handle, m, <const cuDoubleComplex*>dl, <const cuDoubleComplex*>d, <const cuDoubleComplex*>du, <const cuDoubleComplex*>x, batch_count, batch_stride, &buffer_size_in_bytes)
    check_status(__status__)
    return buffer_size_in_bytes
...
cpdef sgtsv2strided_batch(intptr_t handle, int m, intptr_t dl, intptr_t d, intptr_t du, intptr_t x, int batch_count, int batch_stride, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseSgtsv2StridedBatch(<Handle>handle, m, <const float*>dl, <const float*>d, <const float*>du, <float*>x, batch_count, batch_stride, <void*>p_buffer)
    check_status(__status__)
...
cpdef dgtsv2strided_batch(intptr_t handle, int m, intptr_t dl, intptr_t d, intptr_t du, intptr_t x, int batch_count, int batch_stride, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseDgtsv2StridedBatch(<Handle>handle, m, <const double*>dl, <const double*>d, <const double*>du, <double*>x, batch_count, batch_stride, <void*>p_buffer)
    check_status(__status__)
...
cpdef cgtsv2strided_batch(intptr_t handle, int m, intptr_t dl, intptr_t d, intptr_t du, intptr_t x, int batch_count, int batch_stride, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseCgtsv2StridedBatch(<Handle>handle, m, <const cuComplex*>dl, <const cuComplex*>d, <const cuComplex*>du, <cuComplex*>x, batch_count, batch_stride, <void*>p_buffer)
    check_status(__status__)
...
cpdef zgtsv2strided_batch(intptr_t handle, int m, intptr_t dl, intptr_t d, intptr_t du, intptr_t x, int batch_count, int batch_stride, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseZgtsv2StridedBatch(<Handle>handle, m, <const cuDoubleComplex*>dl, <const cuDoubleComplex*>d, <const cuDoubleComplex*>du, <cuDoubleComplex*>x, batch_count, batch_stride, <void*>p_buffer)
    check_status(__status__)
...
cpdef size_t sgtsv_interleaved_batch_buffer_size_ext(intptr_t handle, int algo, int m, intptr_t dl, intptr_t d, intptr_t du, intptr_t x, int batch_count) except? 0:
    ...
    with nogil:
        __status__ = cusparseSgtsvInterleavedBatch_bufferSizeExt(<Handle>handle, algo, m, <const float*>dl, <const float*>d, <const float*>du, <const float*>x, batch_count, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef size_t dgtsv_interleaved_batch_buffer_size_ext(intptr_t handle, int algo, int m, intptr_t dl, intptr_t d, intptr_t du, intptr_t x, int batch_count) except? 0:
    ...
    cdef size_t p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseDgtsvInterleavedBatch_bufferSizeExt(<Handle>handle, algo, m, <const double*>dl, <const double*>d, <const double*>du, <const double*>x, batch_count, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef size_t cgtsv_interleaved_batch_buffer_size_ext(intptr_t handle, int algo, int m, intptr_t dl, intptr_t d, intptr_t du, intptr_t x, int batch_count) except? 0:
    ...
    cdef size_t p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseCgtsvInterleavedBatch_bufferSizeExt(<Handle>handle, algo, m, <const cuComplex*>dl, <const cuComplex*>d, <const cuComplex*>du, <const cuComplex*>x, batch_count, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef size_t zgtsv_interleaved_batch_buffer_size_ext(intptr_t handle, int algo, int m, intptr_t dl, intptr_t d, intptr_t du, intptr_t x, int batch_count) except? 0:
    ...
    cdef size_t p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseZgtsvInterleavedBatch_bufferSizeExt(<Handle>handle, algo, m, <const cuDoubleComplex*>dl, <const cuDoubleComplex*>d, <const cuDoubleComplex*>du, <const cuDoubleComplex*>x, batch_count, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef sgtsv_interleaved_batch(intptr_t handle, int algo, int m, intptr_t dl, intptr_t d, intptr_t du, intptr_t x, int batch_count, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseSgtsvInterleavedBatch(<Handle>handle, algo, m, <float*>dl, <float*>d, <float*>du, <float*>x, batch_count, <void*>p_buffer)
    check_status(__status__)
...
cpdef dgtsv_interleaved_batch(intptr_t handle, int algo, int m, intptr_t dl, intptr_t d, intptr_t du, intptr_t x, int batch_count, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseDgtsvInterleavedBatch(<Handle>handle, algo, m, <double*>dl, <double*>d, <double*>du, <double*>x, batch_count, <void*>p_buffer)
    check_status(__status__)
...
cpdef cgtsv_interleaved_batch(intptr_t handle, int algo, int m, intptr_t dl, intptr_t d, intptr_t du, intptr_t x, int batch_count, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseCgtsvInterleavedBatch(<Handle>handle, algo, m, <cuComplex*>dl, <cuComplex*>d, <cuComplex*>du, <cuComplex*>x, batch_count, <void*>p_buffer)
    check_status(__status__)
...
cpdef zgtsv_interleaved_batch(intptr_t handle, int algo, int m, intptr_t dl, intptr_t d, intptr_t du, intptr_t x, int batch_count, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseZgtsvInterleavedBatch(<Handle>handle, algo, m, <cuDoubleComplex*>dl, <cuDoubleComplex*>d, <cuDoubleComplex*>du, <cuDoubleComplex*>x, batch_count, <void*>p_buffer)
    check_status(__status__)
...
cpdef size_t sgpsv_interleaved_batch_buffer_size_ext(intptr_t handle, int algo, int m, intptr_t ds, intptr_t dl, intptr_t d, intptr_t du, intptr_t dw, intptr_t x, int batch_count) except? 0:
    ...
    cdef size_t p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseSgpsvInterleavedBatch_bufferSizeExt(<Handle>handle, algo, m, <const float*>ds, <const float*>dl, <const float*>d, <const float*>du, <const float*>dw, <const float*>x, batch_count, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef size_t dgpsv_interleaved_batch_buffer_size_ext(intptr_t handle, int algo, int m, intptr_t ds, intptr_t dl, intptr_t d, intptr_t du, intptr_t dw, intptr_t x, int batch_count) except? 0:
    ...
    cdef size_t p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseDgpsvInterleavedBatch_bufferSizeExt(<Handle>handle, algo, m, <const double*>ds, <const double*>dl, <const double*>d, <const double*>du, <const double*>dw, <const double*>x, batch_count, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef size_t cgpsv_interleaved_batch_buffer_size_ext(intptr_t handle, int algo, int m, intptr_t ds, intptr_t dl, intptr_t d, intptr_t du, intptr_t dw, intptr_t x, int batch_count) except? 0:
    ...
    cdef size_t p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseCgpsvInterleavedBatch_bufferSizeExt(<Handle>handle, algo, m, <const cuComplex*>ds, <const cuComplex*>dl, <const cuComplex*>d, <const cuComplex*>du, <const cuComplex*>dw, <const cuComplex*>x, batch_count, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef size_t zgpsv_interleaved_batch_buffer_size_ext(intptr_t handle, int algo, int m, intptr_t ds, intptr_t dl, intptr_t d, intptr_t du, intptr_t dw, intptr_t x, int batch_count) except? 0:
    ...
    cdef size_t p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseZgpsvInterleavedBatch_bufferSizeExt(<Handle>handle, algo, m, <const cuDoubleComplex*>ds, <const cuDoubleComplex*>dl, <const cuDoubleComplex*>d, <const cuDoubleComplex*>du, <const cuDoubleComplex*>dw, <const cuDoubleComplex*>x, batch_count, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef sgpsv_interleaved_batch(intptr_t handle, int algo, int m, intptr_t ds, intptr_t dl, intptr_t d, intptr_t du, intptr_t dw, intptr_t x, int batch_count, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseSgpsvInterleavedBatch(<Handle>handle, algo, m, <float*>ds, <float*>dl, <float*>d, <float*>du, <float*>dw, <float*>x, batch_count, <void*>p_buffer)
    check_status(__status__)
...
cpdef dgpsv_interleaved_batch(intptr_t handle, int algo, int m, intptr_t ds, intptr_t dl, intptr_t d, intptr_t du, intptr_t dw, intptr_t x, int batch_count, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseDgpsvInterleavedBatch(<Handle>handle, algo, m, <double*>ds, <double*>dl, <double*>d, <double*>du, <double*>dw, <double*>x, batch_count, <void*>p_buffer)
    check_status(__status__)
...
cpdef cgpsv_interleaved_batch(intptr_t handle, int algo, int m, intptr_t ds, intptr_t dl, intptr_t d, intptr_t du, intptr_t dw, intptr_t x, int batch_count, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseCgpsvInterleavedBatch(<Handle>handle, algo, m, <cuComplex*>ds, <cuComplex*>dl, <cuComplex*>d, <cuComplex*>du, <cuComplex*>dw, <cuComplex*>x, batch_count, <void*>p_buffer)
    check_status(__status__)
...
cpdef zgpsv_interleaved_batch(intptr_t handle, int algo, int m, intptr_t ds, intptr_t dl, intptr_t d, intptr_t du, intptr_t dw, intptr_t x, int batch_count, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseZgpsvInterleavedBatch(<Handle>handle, algo, m, <cuDoubleComplex*>ds, <cuDoubleComplex*>dl, <cuDoubleComplex*>d, <cuDoubleComplex*>du, <cuDoubleComplex*>dw, <cuDoubleComplex*>x, batch_count, <void*>p_buffer)
    check_status(__status__)
...
cpdef size_t dcsrgeam2_buffer_size_ext(intptr_t handle, int m, int n, intptr_t alpha, intptr_t descr_a, int nnz_a, intptr_t csr_sorted_val_a, intptr_t csr_sorted_row_ptr_a, intptr_t csr_sorted_col_ind_a, intptr_t beta, intptr_t descr_b, int nnz_b, intptr_t csr_sorted_val_b, intptr_t csr_sorted_row_ptr_b, intptr_t csr_sorted_col_ind_b, intptr_t descr_c, intptr_t csr_sorted_val_c, intptr_t csr_sorted_row_ptr_c, intptr_t csr_sorted_col_ind_c) except? 0:
    ...
    cdef size_t p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseDcsrgeam2_bufferSizeExt(<Handle>handle, m, n, <const double*>alpha, <const MatDescr>descr_a, nnz_a, <const double*>csr_sorted_val_a, <const int*>csr_sorted_row_ptr_a, <const int*>csr_sorted_col_ind_a, <const double*>beta, <const MatDescr>descr_b, nnz_b, <const double*>csr_sorted_val_b, <const int*>csr_sorted_row_ptr_b, <const int*>csr_sorted_col_ind_b, <const MatDescr>descr_c, <const double*>csr_sorted_val_c, <const int*>csr_sorted_row_ptr_c, <const int*>csr_sorted_col_ind_c, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef size_t ccsrgeam2_buffer_size_ext(intptr_t handle, int m, int n, intptr_t alpha, intptr_t descr_a, int nnz_a, intptr_t csr_sorted_val_a, intptr_t csr_sorted_row_ptr_a, intptr_t csr_sorted_col_ind_a, intptr_t beta, intptr_t descr_b, int nnz_b, intptr_t csr_sorted_val_b, intptr_t csr_sorted_row_ptr_b, intptr_t csr_sorted_col_ind_b, intptr_t descr_c, intptr_t csr_sorted_val_c, intptr_t csr_sorted_row_ptr_c, intptr_t csr_sorted_col_ind_c) except? 0:
    ...
    cdef size_t p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseCcsrgeam2_bufferSizeExt(<Handle>handle, m, n, <const cuComplex*>alpha, <const MatDescr>descr_a, nnz_a, <const cuComplex*>csr_sorted_val_a, <const int*>csr_sorted_row_ptr_a, <const int*>csr_sorted_col_ind_a, <const cuComplex*>beta, <const MatDescr>descr_b, nnz_b, <const cuComplex*>csr_sorted_val_b, <const int*>csr_sorted_row_ptr_b, <const int*>csr_sorted_col_ind_b, <const MatDescr>descr_c, <const cuComplex*>csr_sorted_val_c, <const int*>csr_sorted_row_ptr_c, <const int*>csr_sorted_col_ind_c, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef size_t zcsrgeam2_buffer_size_ext(intptr_t handle, int m, int n, intptr_t alpha, intptr_t descr_a, int nnz_a, intptr_t csr_sorted_val_a, intptr_t csr_sorted_row_ptr_a, intptr_t csr_sorted_col_ind_a, intptr_t beta, intptr_t descr_b, int nnz_b, intptr_t csr_sorted_val_b, intptr_t csr_sorted_row_ptr_b, intptr_t csr_sorted_col_ind_b, intptr_t descr_c, intptr_t csr_sorted_val_c, intptr_t csr_sorted_row_ptr_c, intptr_t csr_sorted_col_ind_c) except? 0:
    ...
    cdef size_t p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseZcsrgeam2_bufferSizeExt(<Handle>handle, m, n, <const cuDoubleComplex*>alpha, <const MatDescr>descr_a, nnz_a, <const cuDoubleComplex*>csr_sorted_val_a, <const int*>csr_sorted_row_ptr_a, <const int*>csr_sorted_col_ind_a, <const cuDoubleComplex*>beta, <const MatDescr>descr_b, nnz_b, <const cuDoubleComplex*>csr_sorted_val_b, <const int*>csr_sorted_row_ptr_b, <const int*>csr_sorted_col_ind_b, <const MatDescr>descr_c, <const cuDoubleComplex*>csr_sorted_val_c, <const int*>csr_sorted_row_ptr_c, <const int*>csr_sorted_col_ind_c, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef xcsrgeam2nnz(intptr_t handle, int m, int n, intptr_t descr_a, int nnz_a, intptr_t csr_sorted_row_ptr_a, intptr_t csr_sorted_col_ind_a, intptr_t descr_b, int nnz_b, intptr_t csr_sorted_row_ptr_b, intptr_t csr_sorted_col_ind_b, intptr_t descr_c, intptr_t csr_sorted_row_ptr_c, intptr_t nnz_total_dev_host_ptr, intptr_t workspace):
    ...
    with nogil:
        __status__ = cusparseXcsrgeam2Nnz(<Handle>handle, m, n, <const MatDescr>descr_a, nnz_a, <const int*>csr_sorted_row_ptr_a, <const int*>csr_sorted_col_ind_a, <const MatDescr>descr_b, nnz_b, <const int*>csr_sorted_row_ptr_b, <const int*>csr_sorted_col_ind_b, <const MatDescr>descr_c, <int*>csr_sorted_row_ptr_c, <int*>nnz_total_dev_host_ptr, <void*>workspace)
    check_status(__status__)
...
cpdef dcsrgeam2(intptr_t handle, int m, int n, intptr_t alpha, intptr_t descr_a, int nnz_a, intptr_t csr_sorted_val_a, intptr_t csr_sorted_row_ptr_a, intptr_t csr_sorted_col_ind_a, intptr_t beta, intptr_t descr_b, int nnz_b, intptr_t csr_sorted_val_b, intptr_t csr_sorted_row_ptr_b, intptr_t csr_sorted_col_ind_b, intptr_t descr_c, intptr_t csr_sorted_val_c, intptr_t csr_sorted_row_ptr_c, intptr_t csr_sorted_col_ind_c, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseDcsrgeam2(<Handle>handle, m, n, <const double*>alpha, <const MatDescr>descr_a, nnz_a, <const double*>csr_sorted_val_a, <const int*>csr_sorted_row_ptr_a, <const int*>csr_sorted_col_ind_a, <const double*>beta, <const MatDescr>descr_b, nnz_b, <const double*>csr_sorted_val_b, <const int*>csr_sorted_row_ptr_b, <const int*>csr_sorted_col_ind_b, <const MatDescr>descr_c, <double*>csr_sorted_val_c, <int*>csr_sorted_row_ptr_c, <int*>csr_sorted_col_ind_c, <void*>p_buffer)
    check_status(__status__)
...
cpdef ccsrgeam2(intptr_t handle, int m, int n, intptr_t alpha, intptr_t descr_a, int nnz_a, intptr_t csr_sorted_val_a, intptr_t csr_sorted_row_ptr_a, intptr_t csr_sorted_col_ind_a, intptr_t beta, intptr_t descr_b, int nnz_b, intptr_t csr_sorted_val_b, intptr_t csr_sorted_row_ptr_b, intptr_t csr_sorted_col_ind_b, intptr_t descr_c, intptr_t csr_sorted_val_c, intptr_t csr_sorted_row_ptr_c, intptr_t csr_sorted_col_ind_c, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseCcsrgeam2(<Handle>handle, m, n, <const cuComplex*>alpha, <const MatDescr>descr_a, nnz_a, <const cuComplex*>csr_sorted_val_a, <const int*>csr_sorted_row_ptr_a, <const int*>csr_sorted_col_ind_a, <const cuComplex*>beta, <const MatDescr>descr_b, nnz_b, <const cuComplex*>csr_sorted_val_b, <const int*>csr_sorted_row_ptr_b, <const int*>csr_sorted_col_ind_b, <const MatDescr>descr_c, <cuComplex*>csr_sorted_val_c, <int*>csr_sorted_row_ptr_c, <int*>csr_sorted_col_ind_c, <void*>p_buffer)
    check_status(__status__)
...
cpdef zcsrgeam2(intptr_t handle, int m, int n, intptr_t alpha, intptr_t descr_a, int nnz_a, intptr_t csr_sorted_val_a, intptr_t csr_sorted_row_ptr_a, intptr_t csr_sorted_col_ind_a, intptr_t beta, intptr_t descr_b, int nnz_b, intptr_t csr_sorted_val_b, intptr_t csr_sorted_row_ptr_b, intptr_t csr_sorted_col_ind_b, intptr_t descr_c, intptr_t csr_sorted_val_c, intptr_t csr_sorted_row_ptr_c, intptr_t csr_sorted_col_ind_c, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseZcsrgeam2(<Handle>handle, m, n, <const cuDoubleComplex*>alpha, <const MatDescr>descr_a, nnz_a, <const cuDoubleComplex*>csr_sorted_val_a, <const int*>csr_sorted_row_ptr_a, <const int*>csr_sorted_col_ind_a, <const cuDoubleComplex*>beta, <const MatDescr>descr_b, nnz_b, <const cuDoubleComplex*>csr_sorted_val_b, <const int*>csr_sorted_row_ptr_b, <const int*>csr_sorted_col_ind_b, <const MatDescr>descr_c, <cuDoubleComplex*>csr_sorted_val_c, <int*>csr_sorted_row_ptr_c, <int*>csr_sorted_col_ind_c, <void*>p_buffer)
    check_status(__status__)
...
cpdef snnz(intptr_t handle, int dir_a, int m, int n, intptr_t descr_a, intptr_t a, int lda, intptr_t nnz_per_row_col, intptr_t nnz_total_dev_host_ptr):
    """See `cusparseSnnz`."""
    with nogil:
        __status__ = cusparseSnnz(<Handle>handle, <_Direction>dir_a, m, n, <const MatDescr>descr_a, <const float*>a, lda, <int*>nnz_per_row_col, <int*>nnz_total_dev_host_ptr)
    check_status(__status__)
...
cpdef dnnz(intptr_t handle, int dir_a, int m, int n, intptr_t descr_a, intptr_t a, int lda, intptr_t nnz_per_row_col, intptr_t nnz_total_dev_host_ptr):
    """See `cusparseDnnz`."""
    with nogil:
        __status__ = cusparseDnnz(<Handle>handle, <_Direction>dir_a, m, n, <const MatDescr>descr_a, <const double*>a, lda, <int*>nnz_per_row_col, <int*>nnz_total_dev_host_ptr)
    check_status(__status__)
...
cpdef cnnz(intptr_t handle, int dir_a, int m, int n, intptr_t descr_a, intptr_t a, int lda, intptr_t nnz_per_row_col, intptr_t nnz_total_dev_host_ptr):
    """See `cusparseCnnz`."""
    with nogil:
        __status__ = cusparseCnnz(<Handle>handle, <_Direction>dir_a, m, n, <const MatDescr>descr_a, <const cuComplex*>a, lda, <int*>nnz_per_row_col, <int*>nnz_total_dev_host_ptr)
    check_status(__status__)
...
cpdef znnz(intptr_t handle, int dir_a, int m, int n, intptr_t descr_a, intptr_t a, int lda, intptr_t nnz_per_row_col, intptr_t nnz_total_dev_host_ptr):
    """See `cusparseZnnz`."""
    with nogil:
        __status__ = cusparseZnnz(<Handle>handle, <_Direction>dir_a, m, n, <const MatDescr>descr_a, <const cuDoubleComplex*>a, lda, <int*>nnz_per_row_col, <int*>nnz_total_dev_host_ptr)
    check_status(__status__)
...
cpdef xcoo2csr(intptr_t handle, intptr_t coo_row_ind, int nnz, int m, intptr_t csr_sorted_row_ptr, int idx_base):
    ...
    with nogil:
        __status__ = cusparseXcoo2csr(<Handle>handle, <const int*>coo_row_ind, nnz, m, <int*>csr_sorted_row_ptr, <_IndexBase>idx_base)
    check_status(__status__)
...
cpdef sbsr2csr(intptr_t handle, int dir_a, int mb, int nb, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int block_dim, intptr_t descr_c, intptr_t csr_sorted_val_c, intptr_t csr_sorted_row_ptr_c, intptr_t csr_sorted_col_ind_c):
    ...
    with nogil:
        __status__ = cusparseSbsr2csr(<Handle>handle, <_Direction>dir_a, mb, nb, <const MatDescr>descr_a, <const float*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, block_dim, <const MatDescr>descr_c, <float*>csr_sorted_val_c, <int*>csr_sorted_row_ptr_c, <int*>csr_sorted_col_ind_c)
    check_status(__status__)
...
cpdef dbsr2csr(intptr_t handle, int dir_a, int mb, int nb, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int block_dim, intptr_t descr_c, intptr_t csr_sorted_val_c, intptr_t csr_sorted_row_ptr_c, intptr_t csr_sorted_col_ind_c):
    ...
    with nogil:
        __status__ = cusparseDbsr2csr(<Handle>handle, <_Direction>dir_a, mb, nb, <const MatDescr>descr_a, <const double*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, block_dim, <const MatDescr>descr_c, <double*>csr_sorted_val_c, <int*>csr_sorted_row_ptr_c, <int*>csr_sorted_col_ind_c)
    check_status(__status__)
...
cpdef cbsr2csr(intptr_t handle, int dir_a, int mb, int nb, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int block_dim, intptr_t descr_c, intptr_t csr_sorted_val_c, intptr_t csr_sorted_row_ptr_c, intptr_t csr_sorted_col_ind_c):
    ...
    with nogil:
        __status__ = cusparseCbsr2csr(<Handle>handle, <_Direction>dir_a, mb, nb, <const MatDescr>descr_a, <const cuComplex*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, block_dim, <const MatDescr>descr_c, <cuComplex*>csr_sorted_val_c, <int*>csr_sorted_row_ptr_c, <int*>csr_sorted_col_ind_c)
    check_status(__status__)
...
cpdef zbsr2csr(intptr_t handle, int dir_a, int mb, int nb, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int block_dim, intptr_t descr_c, intptr_t csr_sorted_val_c, intptr_t csr_sorted_row_ptr_c, intptr_t csr_sorted_col_ind_c):
    ...
    with nogil:
        __status__ = cusparseZbsr2csr(<Handle>handle, <_Direction>dir_a, mb, nb, <const MatDescr>descr_a, <const cuDoubleComplex*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, block_dim, <const MatDescr>descr_c, <cuDoubleComplex*>csr_sorted_val_c, <int*>csr_sorted_row_ptr_c, <int*>csr_sorted_col_ind_c)
    check_status(__status__)
...
cpdef int sgebsr2gebsc_buffer_size(intptr_t handle, int mb, int nb, int nnzb, intptr_t bsr_sorted_val, intptr_t bsr_sorted_row_ptr, intptr_t bsr_sorted_col_ind, int row_block_dim, int col_block_dim) except? -1:
    ...
    cdef int p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseSgebsr2gebsc_bufferSize(<Handle>handle, mb, nb, nnzb, <const float*>bsr_sorted_val, <const int*>bsr_sorted_row_ptr, <const int*>bsr_sorted_col_ind, row_block_dim, col_block_dim, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef int dgebsr2gebsc_buffer_size(intptr_t handle, int mb, int nb, int nnzb, intptr_t bsr_sorted_val, intptr_t bsr_sorted_row_ptr, intptr_t bsr_sorted_col_ind, int row_block_dim, int col_block_dim) except? -1:
    ...
    cdef int p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseDgebsr2gebsc_bufferSize(<Handle>handle, mb, nb, nnzb, <const double*>bsr_sorted_val, <const int*>bsr_sorted_row_ptr, <const int*>bsr_sorted_col_ind, row_block_dim, col_block_dim, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef int cgebsr2gebsc_buffer_size(intptr_t handle, int mb, int nb, int nnzb, intptr_t bsr_sorted_val, intptr_t bsr_sorted_row_ptr, intptr_t bsr_sorted_col_ind, int row_block_dim, int col_block_dim) except? -1:
    ...
    cdef int p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseCgebsr2gebsc_bufferSize(<Handle>handle, mb, nb, nnzb, <const cuComplex*>bsr_sorted_val, <const int*>bsr_sorted_row_ptr, <const int*>bsr_sorted_col_ind, row_block_dim, col_block_dim, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef int zgebsr2gebsc_buffer_size(intptr_t handle, int mb, int nb, int nnzb, intptr_t bsr_sorted_val, intptr_t bsr_sorted_row_ptr, intptr_t bsr_sorted_col_ind, int row_block_dim, int col_block_dim) except? -1:
    ...
    cdef int p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseZgebsr2gebsc_bufferSize(<Handle>handle, mb, nb, nnzb, <const cuDoubleComplex*>bsr_sorted_val, <const int*>bsr_sorted_row_ptr, <const int*>bsr_sorted_col_ind, row_block_dim, col_block_dim, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef size_t sgebsr2gebsc_buffer_size_ext(intptr_t handle, int mb, int nb, int nnzb, intptr_t bsr_sorted_val, intptr_t bsr_sorted_row_ptr, intptr_t bsr_sorted_col_ind, int row_block_dim, int col_block_dim) except? 0:
    ...
    cdef size_t p_buffer_size
    with nogil:
        __status__ = cusparseSgebsr2gebsc_bufferSizeExt(<Handle>handle, mb, nb, nnzb, <const float*>bsr_sorted_val, <const int*>bsr_sorted_row_ptr, <const int*>bsr_sorted_col_ind, row_block_dim, col_block_dim, &p_buffer_size)
    check_status(__status__)
    return p_buffer_size
...
cpdef size_t dgebsr2gebsc_buffer_size_ext(intptr_t handle, int mb, int nb, int nnzb, intptr_t bsr_sorted_val, intptr_t bsr_sorted_row_ptr, intptr_t bsr_sorted_col_ind, int row_block_dim, int col_block_dim) except? 0:
    ...
    cdef size_t p_buffer_size
    with nogil:
        __status__ = cusparseDgebsr2gebsc_bufferSizeExt(<Handle>handle, mb, nb, nnzb, <const double*>bsr_sorted_val, <const int*>bsr_sorted_row_ptr, <const int*>bsr_sorted_col_ind, row_block_dim, col_block_dim, &p_buffer_size)
    check_status(__status__)
    return p_buffer_size
...
cpdef size_t cgebsr2gebsc_buffer_size_ext(intptr_t handle, int mb, int nb, int nnzb, intptr_t bsr_sorted_val, intptr_t bsr_sorted_row_ptr, intptr_t bsr_sorted_col_ind, int row_block_dim, int col_block_dim) except? 0:
    ...
    cdef size_t p_buffer_size
    with nogil:
        __status__ = cusparseCgebsr2gebsc_bufferSizeExt(<Handle>handle, mb, nb, nnzb, <const cuComplex*>bsr_sorted_val, <const int*>bsr_sorted_row_ptr, <const int*>bsr_sorted_col_ind, row_block_dim, col_block_dim, &p_buffer_size)
    check_status(__status__)
    return p_buffer_size
...
cpdef size_t zgebsr2gebsc_buffer_size_ext(intptr_t handle, int mb, int nb, int nnzb, intptr_t bsr_sorted_val, intptr_t bsr_sorted_row_ptr, intptr_t bsr_sorted_col_ind, int row_block_dim, int col_block_dim) except? 0:
    ...
    cdef size_t p_buffer_size
    with nogil:
        __status__ = cusparseZgebsr2gebsc_bufferSizeExt(<Handle>handle, mb, nb, nnzb, <const cuDoubleComplex*>bsr_sorted_val, <const int*>bsr_sorted_row_ptr, <const int*>bsr_sorted_col_ind, row_block_dim, col_block_dim, &p_buffer_size)
    check_status(__status__)
    return p_buffer_size
...
cpdef sgebsr2gebsc(intptr_t handle, int mb, int nb, int nnzb, intptr_t bsr_sorted_val, intptr_t bsr_sorted_row_ptr, intptr_t bsr_sorted_col_ind, int row_block_dim, int col_block_dim, intptr_t bsc_val, intptr_t bsc_row_ind, intptr_t bsc_col_ptr, int copy_values, int idx_base, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseSgebsr2gebsc(<Handle>handle, mb, nb, nnzb, <const float*>bsr_sorted_val, <const int*>bsr_sorted_row_ptr, <const int*>bsr_sorted_col_ind, row_block_dim, col_block_dim, <float*>bsc_val, <int*>bsc_row_ind, <int*>bsc_col_ptr, <_Action>copy_values, <_IndexBase>idx_base, <void*>p_buffer)
    check_status(__status__)
...
cpdef dgebsr2gebsc(intptr_t handle, int mb, int nb, int nnzb, intptr_t bsr_sorted_val, intptr_t bsr_sorted_row_ptr, intptr_t bsr_sorted_col_ind, int row_block_dim, int col_block_dim, intptr_t bsc_val, intptr_t bsc_row_ind, intptr_t bsc_col_ptr, int copy_values, int idx_base, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseDgebsr2gebsc(<Handle>handle, mb, nb, nnzb, <const double*>bsr_sorted_val, <const int*>bsr_sorted_row_ptr, <const int*>bsr_sorted_col_ind, row_block_dim, col_block_dim, <double*>bsc_val, <int*>bsc_row_ind, <int*>bsc_col_ptr, <_Action>copy_values, <_IndexBase>idx_base, <void*>p_buffer)
    check_status(__status__)
...
cpdef cgebsr2gebsc(intptr_t handle, int mb, int nb, int nnzb, intptr_t bsr_sorted_val, intptr_t bsr_sorted_row_ptr, intptr_t bsr_sorted_col_ind, int row_block_dim, int col_block_dim, intptr_t bsc_val, intptr_t bsc_row_ind, intptr_t bsc_col_ptr, int copy_values, int idx_base, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseCgebsr2gebsc(<Handle>handle, mb, nb, nnzb, <const cuComplex*>bsr_sorted_val, <const int*>bsr_sorted_row_ptr, <const int*>bsr_sorted_col_ind, row_block_dim, col_block_dim, <cuComplex*>bsc_val, <int*>bsc_row_ind, <int*>bsc_col_ptr, <_Action>copy_values, <_IndexBase>idx_base, <void*>p_buffer)
    check_status(__status__)
...
cpdef int scsr2gebsr_buffer_size(intptr_t handle, int dir_a, int m, int n, intptr_t descr_a, intptr_t csr_sorted_val_a, intptr_t csr_sorted_row_ptr_a, intptr_t csr_sorted_col_ind_a, int row_block_dim, int col_block_dim) except? -1:
    ...
    cdef int p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseScsr2gebsr_bufferSize(<Handle>handle, <_Direction>dir_a, m, n, <const MatDescr>descr_a, <const float*>csr_sorted_val_a, <const int*>csr_sorted_row_ptr_a, <const int*>csr_sorted_col_ind_a, row_block_dim, col_block_dim, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef int dcsr2gebsr_buffer_size(intptr_t handle, int dir_a, int m, int n, intptr_t descr_a, intptr_t csr_sorted_val_a, intptr_t csr_sorted_row_ptr_a, intptr_t csr_sorted_col_ind_a, int row_block_dim, int col_block_dim) except? -1:
    ...
    cdef int p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseDcsr2gebsr_bufferSize(<Handle>handle, <_Direction>dir_a, m, n, <const MatDescr>descr_a, <const double*>csr_sorted_val_a, <const int*>csr_sorted_row_ptr_a, <const int*>csr_sorted_col_ind_a, row_block_dim, col_block_dim, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef int ccsr2gebsr_buffer_size(intptr_t handle, int dir_a, int m, int n, intptr_t descr_a, intptr_t csr_sorted_val_a, intptr_t csr_sorted_row_ptr_a, intptr_t csr_sorted_col_ind_a, int row_block_dim, int col_block_dim) except? -1:
    ...
    cdef int p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseCcsr2gebsr_bufferSize(<Handle>handle, <_Direction>dir_a, m, n, <const MatDescr>descr_a, <const cuComplex*>csr_sorted_val_a, <const int*>csr_sorted_row_ptr_a, <const int*>csr_sorted_col_ind_a, row_block_dim, col_block_dim, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef int zcsr2gebsr_buffer_size(intptr_t handle, int dir_a, int m, int n, intptr_t descr_a, intptr_t csr_sorted_val_a, intptr_t csr_sorted_row_ptr_a, intptr_t csr_sorted_col_ind_a, int row_block_dim, int col_block_dim) except? -1:
    ...
    cdef int p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseZcsr2gebsr_bufferSize(<Handle>handle, <_Direction>dir_a, m, n, <const MatDescr>descr_a, <const cuDoubleComplex*>csr_sorted_val_a, <const int*>csr_sorted_row_ptr_a, <const int*>csr_sorted_col_ind_a, row_block_dim, col_block_dim, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef size_t scsr2gebsr_buffer_size_ext(intptr_t handle, int dir_a, int m, int n, intptr_t descr_a, intptr_t csr_sorted_val_a, intptr_t csr_sorted_row_ptr_a, intptr_t csr_sorted_col_ind_a, int row_block_dim, int col_block_dim) except? 0:
    ...
    cdef size_t p_buffer_size
    with nogil:
        __status__ = cusparseScsr2gebsr_bufferSizeExt(<Handle>handle, <_Direction>dir_a, m, n, <const MatDescr>descr_a, <const float*>csr_sorted_val_a, <const int*>csr_sorted_row_ptr_a, <const int*>csr_sorted_col_ind_a, row_block_dim, col_block_dim, &p_buffer_size)
    check_status(__status__)
    return p_buffer_size
...
cpdef size_t dcsr2gebsr_buffer_size_ext(intptr_t handle, int dir_a, int m, int n, intptr_t descr_a, intptr_t csr_sorted_val_a, intptr_t csr_sorted_row_ptr_a, intptr_t csr_sorted_col_ind_a, int row_block_dim, int col_block_dim) except? 0:
    ...
    cdef size_t p_buffer_size
    with nogil:
        __status__ = cusparseDcsr2gebsr_bufferSizeExt(<Handle>handle, <_Direction>dir_a, m, n, <const MatDescr>descr_a, <const double*>csr_sorted_val_a, <const int*>csr_sorted_row_ptr_a, <const int*>csr_sorted_col_ind_a, row_block_dim, col_block_dim, &p_buffer_size)
    check_status(__status__)
    return p_buffer_size
...
cpdef size_t ccsr2gebsr_buffer_size_ext(intptr_t handle, int dir_a, int m, int n, intptr_t descr_a, intptr_t csr_sorted_val_a, intptr_t csr_sorted_row_ptr_a, intptr_t csr_sorted_col_ind_a, int row_block_dim, int col_block_dim) except? 0:
    ...
    cdef size_t p_buffer_size
    with nogil:
        __status__ = cusparseCcsr2gebsr_bufferSizeExt(<Handle>handle, <_Direction>dir_a, m, n, <const MatDescr>descr_a, <const cuComplex*>csr_sorted_val_a, <const int*>csr_sorted_row_ptr_a, <const int*>csr_sorted_col_ind_a, row_block_dim, col_block_dim, &p_buffer_size)
    check_status(__status__)
    return p_buffer_size
...
cpdef size_t zcsr2gebsr_buffer_size_ext(intptr_t handle, int dir_a, int m, int n, intptr_t descr_a, intptr_t csr_sorted_val_a, intptr_t csr_sorted_row_ptr_a, intptr_t csr_sorted_col_ind_a, int row_block_dim, int col_block_dim) except? 0:
    ...
    cdef size_t p_buffer_size
    with nogil:
        __status__ = cusparseZcsr2gebsr_bufferSizeExt(<Handle>handle, <_Direction>dir_a, m, n, <const MatDescr>descr_a, <const cuDoubleComplex*>csr_sorted_val_a, <const int*>csr_sorted_row_ptr_a, <const int*>csr_sorted_col_ind_a, row_block_dim, col_block_dim, &p_buffer_size)
    check_status(__status__)
    return p_buffer_size
...
cpdef xcsr2gebsr_nnz(intptr_t handle, int dir_a, int m, int n, intptr_t descr_a, intptr_t csr_sorted_row_ptr_a, intptr_t csr_sorted_col_ind_a, intptr_t descr_c, intptr_t bsr_sorted_row_ptr_c, int row_block_dim, int col_block_dim, intptr_t nnz_total_dev_host_ptr, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseXcsr2gebsrNnz(<Handle>handle, <_Direction>dir_a, m, n, <const MatDescr>descr_a, <const int*>csr_sorted_row_ptr_a, <const int*>csr_sorted_col_ind_a, <const MatDescr>descr_c, <int*>bsr_sorted_row_ptr_c, row_block_dim, col_block_dim, <int*>nnz_total_dev_host_ptr, <void*>p_buffer)
    check_status(__status__)
...
cpdef dcsr2gebsr(intptr_t handle, int dir_a, int m, int n, intptr_t descr_a, intptr_t csr_sorted_val_a, intptr_t csr_sorted_row_ptr_a, intptr_t csr_sorted_col_ind_a, intptr_t descr_c, intptr_t bsr_sorted_val_c, intptr_t bsr_sorted_row_ptr_c, intptr_t bsr_sorted_col_ind_c, int row_block_dim, int col_block_dim, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseDcsr2gebsr(<Handle>handle, <_Direction>dir_a, m, n, <const MatDescr>descr_a, <const double*>csr_sorted_val_a, <const int*>csr_sorted_row_ptr_a, <const int*>csr_sorted_col_ind_a, <const MatDescr>descr_c, <double*>bsr_sorted_val_c, <int*>bsr_sorted_row_ptr_c, <int*>bsr_sorted_col_ind_c, row_block_dim, col_block_dim, <void*>p_buffer)
    check_status(__status__)
...
cpdef ccsr2gebsr(intptr_t handle, int dir_a, int m, int n, intptr_t descr_a, intptr_t csr_sorted_val_a, intptr_t csr_sorted_row_ptr_a, intptr_t csr_sorted_col_ind_a, intptr_t descr_c, intptr_t bsr_sorted_val_c, intptr_t bsr_sorted_row_ptr_c, intptr_t bsr_sorted_col_ind_c, int row_block_dim, int col_block_dim, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseCcsr2gebsr(<Handle>handle, <_Direction>dir_a, m, n, <const MatDescr>descr_a, <const cuComplex*>csr_sorted_val_a, <const int*>csr_sorted_row_ptr_a, <const int*>csr_sorted_col_ind_a, <const MatDescr>descr_c, <cuComplex*>bsr_sorted_val_c, <int*>bsr_sorted_row_ptr_c, <int*>bsr_sorted_col_ind_c, row_block_dim, col_block_dim, <void*>p_buffer)
    check_status(__status__)
...
cpdef zcsr2gebsr(intptr_t handle, int dir_a, int m, int n, intptr_t descr_a, intptr_t csr_sorted_val_a, intptr_t csr_sorted_row_ptr_a, intptr_t csr_sorted_col_ind_a, intptr_t descr_c, intptr_t bsr_sorted_val_c, intptr_t bsr_sorted_row_ptr_c, intptr_t bsr_sorted_col_ind_c, int row_block_dim, int col_block_dim, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseZcsr2gebsr(<Handle>handle, <_Direction>dir_a, m, n, <const MatDescr>descr_a, <const cuDoubleComplex*>csr_sorted_val_a, <const int*>csr_sorted_row_ptr_a, <const int*>csr_sorted_col_ind_a, <const MatDescr>descr_c, <cuDoubleComplex*>bsr_sorted_val_c, <int*>bsr_sorted_row_ptr_c, <int*>bsr_sorted_col_ind_c, row_block_dim, col_block_dim, <void*>p_buffer)
    check_status(__status__)
...
cpdef int sgebsr2gebsr_buffer_size(intptr_t handle, int dir_a, int mb, int nb, int nnzb, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int row_block_dim_a, int col_block_dim_a, int row_block_dim_c, int col_block_dim_c) except? -1:
    ...
    cdef int p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseSgebsr2gebsr_bufferSize(<Handle>handle, <_Direction>dir_a, mb, nb, nnzb, <const MatDescr>descr_a, <const float*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, row_block_dim_a, col_block_dim_a, row_block_dim_c, col_block_dim_c, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef int dgebsr2gebsr_buffer_size(intptr_t handle, int dir_a, int mb, int nb, int nnzb, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int row_block_dim_a, int col_block_dim_a, int row_block_dim_c, int col_block_dim_c) except? -1:
    ...
    cdef int p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseDgebsr2gebsr_bufferSize(<Handle>handle, <_Direction>dir_a, mb, nb, nnzb, <const MatDescr>descr_a, <const double*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, row_block_dim_a, col_block_dim_a, row_block_dim_c, col_block_dim_c, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef int cgebsr2gebsr_buffer_size(intptr_t handle, int dir_a, int mb, int nb, int nnzb, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int row_block_dim_a, int col_block_dim_a, int row_block_dim_c, int col_block_dim_c) except? -1:
    ...
    cdef int p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseCgebsr2gebsr_bufferSize(<Handle>handle, <_Direction>dir_a, mb, nb, nnzb, <const MatDescr>descr_a, <const cuComplex*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, row_block_dim_a, col_block_dim_a, row_block_dim_c, col_block_dim_c, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef int zgebsr2gebsr_buffer_size(intptr_t handle, int dir_a, int mb, int nb, int nnzb, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int row_block_dim_a, int col_block_dim_a, int row_block_dim_c, int col_block_dim_c) except? -1:
    ...
    cdef int p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseZgebsr2gebsr_bufferSize(<Handle>handle, <_Direction>dir_a, mb, nb, nnzb, <const MatDescr>descr_a, <const cuDoubleComplex*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, row_block_dim_a, col_block_dim_a, row_block_dim_c, col_block_dim_c, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef size_t sgebsr2gebsr_buffer_size_ext(intptr_t handle, int dir_a, int mb, int nb, int nnzb, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int row_block_dim_a, int col_block_dim_a, int row_block_dim_c, int col_block_dim_c) except? 0:
    ...
    cdef size_t p_buffer_size
    with nogil:
        __status__ = cusparseSgebsr2gebsr_bufferSizeExt(<Handle>handle, <_Direction>dir_a, mb, nb, nnzb, <const MatDescr>descr_a, <const float*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, row_block_dim_a, col_block_dim_a, row_block_dim_c, col_block_dim_c, &p_buffer_size)
    check_status(__status__)
    return p_buffer_size
...
cpdef size_t dgebsr2gebsr_buffer_size_ext(intptr_t handle, int dir_a, int mb, int nb, int nnzb, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int row_block_dim_a, int col_block_dim_a, int row_block_dim_c, int col_block_dim_c) except? 0:
    ...
    cdef size_t p_buffer_size
    with nogil:
        __status__ = cusparseDgebsr2gebsr_bufferSizeExt(<Handle>handle, <_Direction>dir_a, mb, nb, nnzb, <const MatDescr>descr_a, <const double*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, row_block_dim_a, col_block_dim_a, row_block_dim_c, col_block_dim_c, &p_buffer_size)
    check_status(__status__)
    return p_buffer_size
...
cpdef size_t cgebsr2gebsr_buffer_size_ext(intptr_t handle, int dir_a, int mb, int nb, int nnzb, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int row_block_dim_a, int col_block_dim_a, int row_block_dim_c, int col_block_dim_c) except? 0:
    ...
    cdef size_t p_buffer_size
    with nogil:
        __status__ = cusparseCgebsr2gebsr_bufferSizeExt(<Handle>handle, <_Direction>dir_a, mb, nb, nnzb, <const MatDescr>descr_a, <const cuComplex*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, row_block_dim_a, col_block_dim_a, row_block_dim_c, col_block_dim_c, &p_buffer_size)
    check_status(__status__)
    return p_buffer_size
...
cpdef size_t zgebsr2gebsr_buffer_size_ext(intptr_t handle, int dir_a, int mb, int nb, int nnzb, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int row_block_dim_a, int col_block_dim_a, int row_block_dim_c, int col_block_dim_c) except? 0:
    ...
    cdef size_t p_buffer_size
    with nogil:
        __status__ = cusparseZgebsr2gebsr_bufferSizeExt(<Handle>handle, <_Direction>dir_a, mb, nb, nnzb, <const MatDescr>descr_a, <const cuDoubleComplex*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, row_block_dim_a, col_block_dim_a, row_block_dim_c, col_block_dim_c, &p_buffer_size)
    check_status(__status__)
    return p_buffer_size
...
cpdef dgebsr2gebsr(intptr_t handle, int dir_a, int mb, int nb, int nnzb, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int row_block_dim_a, int col_block_dim_a, intptr_t descr_c, intptr_t bsr_sorted_val_c, intptr_t bsr_sorted_row_ptr_c, intptr_t bsr_sorted_col_ind_c, int row_block_dim_c, int col_block_dim_c, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseDgebsr2gebsr(<Handle>handle, <_Direction>dir_a, mb, nb, nnzb, <const MatDescr>descr_a, <const double*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, row_block_dim_a, col_block_dim_a, <const MatDescr>descr_c, <double*>bsr_sorted_val_c, <int*>bsr_sorted_row_ptr_c, <int*>bsr_sorted_col_ind_c, row_block_dim_c, col_block_dim_c, <void*>p_buffer)
    check_status(__status__)
...
cpdef cgebsr2gebsr(intptr_t handle, int dir_a, int mb, int nb, int nnzb, intptr_t descr_a, intptr_t bsr_sorted_val_a, intptr_t bsr_sorted_row_ptr_a, intptr_t bsr_sorted_col_ind_a, int row_block_dim_a, int col_block_dim_a, intptr_t descr_c, intptr_t bsr_sorted_val_c, intptr_t bsr_sorted_row_ptr_c, intptr_t bsr_sorted_col_ind_c, int row_block_dim_c, int col_block_dim_c, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseCgebsr2gebsr(<Handle>handle, <_Direction>dir_a, mb, nb, nnzb, <const MatDescr>descr_a, <const cuComplex*>bsr_sorted_val_a, <const int*>bsr_sorted_row_ptr_a, <const int*>bsr_sorted_col_ind_a, row_block_dim_a, col_block_dim_a, <const MatDescr>descr_c, <cuComplex*>bsr_sorted_val_c, <int*>bsr_sorted_row_ptr_c, <int*>bsr_sorted_col_ind_c, row_block_dim_c, col_block_dim_c, <void*>p_buffer)
    check_status(__status__)
...
cpdef size_t xcoosort_buffer_size_ext(intptr_t handle, int m, int n, int nnz, intptr_t coo_rows_a, intptr_t coo_cols_a) except? 0:
    ...
    cdef size_t p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseXcoosort_bufferSizeExt(<Handle>handle, m, n, nnz, <const int*>coo_rows_a, <const int*>coo_cols_a, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef xcoosort_by_row(intptr_t handle, int m, int n, int nnz, intptr_t coo_rows_a, intptr_t coo_cols_a, intptr_t p, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseXcoosortByRow(<Handle>handle, m, n, nnz, <int*>coo_rows_a, <int*>coo_cols_a, <int*>p, <void*>p_buffer)
    check_status(__status__)
...
cpdef xcoosort_by_column(intptr_t handle, int m, int n, int nnz, intptr_t coo_rows_a, intptr_t coo_cols_a, intptr_t p, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseXcoosortByColumn(<Handle>handle, m, n, nnz, <int*>coo_rows_a, <int*>coo_cols_a, <int*>p, <void*>p_buffer)
    check_status(__status__)
...
cpdef size_t xcsrsort_buffer_size_ext(intptr_t handle, int m, int n, int nnz, intptr_t csr_row_ptr_a, intptr_t csr_col_ind_a) except? 0:
    ...
    cdef size_t p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseXcsrsort_bufferSizeExt(<Handle>handle, m, n, nnz, <const int*>csr_row_ptr_a, <const int*>csr_col_ind_a, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef xcsrsort(intptr_t handle, int m, int n, int nnz, intptr_t descr_a, intptr_t csr_row_ptr_a, intptr_t csr_col_ind_a, intptr_t p, intptr_t p_buffer):
    ...
    with nogil:
        __status__ = cusparseXcsrsort(<Handle>handle, m, n, nnz, <const MatDescr>descr_a, <const int*>csr_row_ptr_a, <int*>csr_col_ind_a, <int*>p, <void*>p_buffer)
    check_status(__status__)
...
cpdef size_t xcscsort_buffer_size_ext(intptr_t handle, int m, int n, int nnz, intptr_t csc_col_ptr_a, intptr_t csc_row_ind_a) except? 0:
    ...
    cdef size_t p_buffer_size_in_bytes
    with nogil:
        __status__ = cusparseXcscsort_bufferSizeExt(<Handle>handle, m, n, nnz, <const int*>csc_col_ptr_a, <const int*>csc_row_ind_a, &p_buffer_size_in_bytes)
    check_status(__status__)
    return p_buffer_size_in_bytes
...
cpdef csr2csc_ex2(intptr_t handle, int m, int n, int nnz, intptr_t csr_val, intptr_t csr_row_ptr, intptr_t csr_col_ind, intptr_t csc_val, intptr_t csc_col_ptr, intptr_t csc_row_ind, int val_type, int copy_values, int idx_base, int alg, intptr_t buffer):
    ...
    with nogil:
        __status__ = cusparseCsr2cscEx2(<Handle>handle, m, n, nnz, <const void*>csr_val, <const int*>csr_row_ptr, <const int*>csr_col_ind, <void*>csc_val, <int*>csc_col_ptr, <int*>csc_row_ind, <DataType>val_type, <_Action>copy_values, <_IndexBase>idx_base, <_Csr2CscAlg>alg, <void*>buffer)
    check_status(__status__)
...
cpdef size_t csr2csc_ex2_buffer_size(intptr_t handle, int m, int n, int nnz, intptr_t csr_val, intptr_t csr_row_ptr, intptr_t csr_col_ind, intptr_t csc_val, intptr_t csc_col_ptr, intptr_t csc_row_ind, int val_type, int copy_values, int idx_base, int alg) except? 0:
    ...
    with nogil:
        __status__ = cusparseCsr2cscEx2_bufferSize(<Handle>handle, m, n, nnz, <const void*>csr_val, <const int*>csr_row_ptr, <const int*>csr_col_ind, <void*>csc_val, <int*>csc_col_ptr, <int*>csc_row_ind, <DataType>val_type, <_Action>copy_values, <_IndexBase>idx_base, <_Csr2CscAlg>alg, &buffer_size)
    check_status(__status__)
    return buffer_size
...
cpdef intptr_t create_sp_vec(int64_t size, int64_t nnz, intptr_t indices, intptr_t values, int idx_type, int idx_base, int value_type) except? 0:
    ...
    with nogil:
        __status__ = cusparseCreateSpVec(&sp_vec_descr, size, nnz, <void*>indices, <void*>values, <_IndexType>idx_type, <_IndexBase>idx_base, <DataType>value_type)
    check_status(__status__)
...
cpdef intptr_t create_const_sp_vec(int64_t size, int64_t nnz, intptr_t indices, intptr_t values, int idx_type, int idx_base, int value_type) except? 0:
    ...
    with nogil:
        __status__ = cusparseCreateConstSpVec(&sp_vec_descr, size, nnz, <const void*>indices, <const void*>values, <_IndexType>idx_type, <_IndexBase>idx_base, <DataType>value_type)
    check_status(__status__)
    return <intptr_t>sp_vec_descr
...
cpdef destroy_sp_vec(intptr_t sp_vec_descr):
    ...
    with nogil:
        __status__ = cusparseDestroySpVec(<ConstSpVecDescr>sp_vec_descr)
    check_status(__status__)
...
cpdef tuple sp_vec_get(intptr_t sp_vec_descr):
    ...
    with nogil:
        __status__ = cusparseSpVecGet(<SpVecDescr>sp_vec_descr, &size, &nnz, &indices, &values, &idx_type, &idx_base, &value_type)
    check_status(__status__)
...
cpdef tuple const_sp_vec_get(intptr_t sp_vec_descr):
    ...
    cdef DataType value_type
    with nogil:
        __status__ = cusparseConstSpVecGet(<ConstSpVecDescr>sp_vec_descr, &size, &nnz, &indices, &values, &idx_type, &idx_base, &value_type)
    check_status(__status__)
    return (size, nnz, <intptr_t>indices, <intptr_t>values, <int>idx_type, <int>idx_base, <int>value_type)
...
cpdef int sp_vec_get_index_base(intptr_t sp_vec_descr) except? -1:
    ...
    cdef _IndexBase idx_base
    with nogil:
        __status__ = cusparseSpVecGetIndexBase(<ConstSpVecDescr>sp_vec_descr, &idx_base)
    check_status(__status__)
    return <int>idx_base
...
cpdef intptr_t sp_vec_get_values(intptr_t sp_vec_descr) except? -1:
    ...
    cdef void* values
    with nogil:
        __status__ = cusparseSpVecGetValues(<SpVecDescr>sp_vec_descr, &values)
    check_status(__status__)
...
cpdef intptr_t const_sp_vec_get_values(intptr_t sp_vec_descr) except? -1:
    ...
    cdef const void* values
    with nogil:
        __status__ = cusparseConstSpVecGetValues(<ConstSpVecDescr>sp_vec_descr, &values)
    check_status(__status__)
    return <intptr_t>values
...
cpdef sp_vec_set_values(intptr_t sp_vec_descr, intptr_t values):
    ...
    with nogil:
        __status__ = cusparseSpVecSetValues(<SpVecDescr>sp_vec_descr, <void*>values)
    check_status(__status__)
...
cpdef intptr_t create_dn_vec(int64_t size, intptr_t values, int value_type) except? 0:
    ...
    with nogil:
        __status__ = cusparseCreateDnVec(&dn_vec_descr, size, <void*>values, <DataType>value_type)
    check_status(__status__)
...
cpdef intptr_t create_const_dn_vec(int64_t size, intptr_t values, int value_type) except? 0:
    ...
    with nogil:
        __status__ = cusparseCreateConstDnVec(&dn_vec_descr, size, <const void*>values, <DataType>value_type)
    check_status(__status__)
    return <intptr_t>dn_vec_descr
...
cpdef destroy_dn_vec(intptr_t dn_vec_descr):
    ...
    with nogil:
        __status__ = cusparseDestroyDnVec(<ConstDnVecDescr>dn_vec_descr)
    check_status(__status__)
...
cpdef tuple dn_vec_get(intptr_t dn_vec_descr):
    ...
    cdef DataType value_type
    with nogil:
        __status__ = cusparseDnVecGet(<DnVecDescr>dn_vec_descr, &size, &values, &value_type)
    check_status(__status__)
...
cpdef tuple const_dn_vec_get(intptr_t dn_vec_descr):
    ...
    cdef DataType value_type
    with nogil:
        __status__ = cusparseConstDnVecGet(<ConstDnVecDescr>dn_vec_descr, &size, &values, &value_type)
    check_status(__status__)
    return (size, <intptr_t>values, <int>value_type)
...
cpdef intptr_t dn_vec_get_values(intptr_t dn_vec_descr) except? -1:
    ...
    cdef void* values
    with nogil:
        __status__ = cusparseDnVecGetValues(<DnVecDescr>dn_vec_descr, &values)
    check_status(__status__)
    return <intptr_t>values
...
cpdef intptr_t const_dn_vec_get_values(intptr_t dn_vec_descr) except? -1:
    ...
    cdef const void* values
    with nogil:
        __status__ = cusparseConstDnVecGetValues(<ConstDnVecDescr>dn_vec_descr, &values)
    check_status(__status__)
    return <intptr_t>values
...
cpdef dn_vec_set_values(intptr_t dn_vec_descr, intptr_t values):
    ...
    with nogil:
        __status__ = cusparseDnVecSetValues(<DnVecDescr>dn_vec_descr, <void*>values)
    check_status(__status__)
...
cpdef destroy_sp_mat(intptr_t sp_mat_descr):
    ...
    with nogil:
        __status__ = cusparseDestroySpMat(<ConstSpMatDescr>sp_mat_descr)
    check_status(__status__)
...
cpdef int sp_mat_get_format(intptr_t sp_mat_descr) except? -1:
    ...
    cdef _Format format
    with nogil:
        __status__ = cusparseSpMatGetFormat(<ConstSpMatDescr>sp_mat_descr, &format)
    check_status(__status__)
    return <int>format
...
cpdef int sp_mat_get_index_base(intptr_t sp_mat_descr) except? -1:
    ...
    cdef _IndexBase idx_base
    with nogil:
        __status__ = cusparseSpMatGetIndexBase(<ConstSpMatDescr>sp_mat_descr, &idx_base)
    check_status(__status__)
    return <int>idx_base
...
cpdef intptr_t sp_mat_get_values(intptr_t sp_mat_descr) except? -1:
    ...
    cdef void* values
    with nogil:
        __status__ = cusparseSpMatGetValues(<SpMatDescr>sp_mat_descr, &values)
    check_status(__status__)
    return <intptr_t>values
...
cpdef intptr_t const_sp_mat_get_values(intptr_t sp_mat_descr) except? -1:
    ...
    cdef const void* values
    with nogil:
        __status__ = cusparseConstSpMatGetValues(<ConstSpMatDescr>sp_mat_descr, &values)
    check_status(__status__)
    return <intptr_t>values
...
cpdef sp_mat_set_values(intptr_t sp_mat_descr, intptr_t values):
    ...
    with nogil:
        __status__ = cusparseSpMatSetValues(<SpMatDescr>sp_mat_descr, <void*>values)
    check_status(__status__)
...
cpdef tuple sp_mat_get_size(intptr_t sp_mat_descr):
    ...
    cdef int64_t nnz
    with nogil:
        __status__ = cusparseSpMatGetSize(<ConstSpMatDescr>sp_mat_descr, &rows, &cols, &nnz)
    check_status(__status__)
...
cpdef int sp_mat_get_strided_batch(intptr_t sp_mat_descr) except? -1:
    ...
    with nogil:
        __status__ = cusparseSpMatGetStridedBatch(<ConstSpMatDescr>sp_mat_descr, &batch_count)
    check_status(__status__)
    return batch_count
...
cpdef coo_set_strided_batch(intptr_t sp_mat_descr, int batch_count, int64_t batch_stride):
    ...
    with nogil:
        __status__ = cusparseCooSetStridedBatch(<SpMatDescr>sp_mat_descr, batch_count, batch_stride)
    check_status(__status__)
...
cpdef csr_set_strided_batch(intptr_t sp_mat_descr, int batch_count, int64_t offsets_batch_stride, int64_t columns_values_batch_stride):
    ...
    with nogil:
        __status__ = cusparseCsrSetStridedBatch(<SpMatDescr>sp_mat_descr, batch_count, offsets_batch_stride, columns_values_batch_stride)
    check_status(__status__)
...
cpdef sp_mat_get_attribute(intptr_t sp_mat_descr, int attribute, intptr_t data, size_t data_size):
    ...
    with nogil:
        __status__ = cusparseSpMatGetAttribute(<ConstSpMatDescr>sp_mat_descr, <_SpMatAttribute>attribute, <void*>data, data_size)
    check_status(__status__)
...
cpdef sp_mat_set_attribute(intptr_t sp_mat_descr, int attribute, intptr_t data, size_t data_size):
    ...
    with nogil:
        __status__ = cusparseSpMatSetAttribute(<SpMatDescr>sp_mat_descr, <_SpMatAttribute>attribute, <void*>data, data_size)
    check_status(__status__)
...
cpdef intptr_t create_csr(int64_t rows, int64_t cols, int64_t nnz, intptr_t csr_row_offsets, intptr_t csr_col_ind, intptr_t csr_values, int csr_row_offsets_type, int csr_col_ind_type, int idx_base, int value_type) except? 0:
    ...
    with nogil:
        __status__ = cusparseCreateCsr(&sp_mat_descr, rows, cols, nnz, <void*>csr_row_offsets, <void*>csr_col_ind, <void*>csr_values, <_IndexType>csr_row_offsets_type, <_IndexType>csr_col_ind_type, <_IndexBase>idx_base, <DataType>value_type)
    check_status(__status__)
...
cpdef intptr_t create_const_csr(int64_t rows, int64_t cols, int64_t nnz, intptr_t csr_row_offsets, intptr_t csr_col_ind, intptr_t csr_values, int csr_row_offsets_type, int csr_col_ind_type, int idx_base, int value_type) except? 0:
    ...
    with nogil:
        __status__ = cusparseCreateConstCsr(&sp_mat_descr, rows, cols, nnz, <const void*>csr_row_offsets, <const void*>csr_col_ind, <const void*>csr_values, <_IndexType>csr_row_offsets_type, <_IndexType>csr_col_ind_type, <_IndexBase>idx_base, <DataType>value_type)
    check_status(__status__)
    return <intptr_t>sp_mat_descr
...
cpdef intptr_t create_csc(int64_t rows, int64_t cols, int64_t nnz, intptr_t csc_col_offsets, intptr_t csc_row_ind, intptr_t csc_values, int csc_col_offsets_type, int csc_row_ind_type, int idx_base, int value_type) except? 0:
    ...
    cdef SpMatDescr sp_mat_descr
    with nogil:
        __status__ = cusparseCreateCsc(&sp_mat_descr, rows, cols, nnz, <void*>csc_col_offsets, <void*>csc_row_ind, <void*>csc_values, <_IndexType>csc_col_offsets_type, <_IndexType>csc_row_ind_type, <_IndexBase>idx_base, <DataType>value_type)
    check_status(__status__)
    return <intptr_t>sp_mat_descr
...
cpdef intptr_t create_const_csc(int64_t rows, int64_t cols, int64_t nnz, intptr_t csc_col_offsets, intptr_t csc_row_ind, intptr_t csc_values, int csc_col_offsets_type, int csc_row_ind_type, int idx_base, int value_type) except? 0:
    ...
    cdef ConstSpMatDescr sp_mat_descr
    with nogil:
        __status__ = cusparseCreateConstCsc(&sp_mat_descr, rows, cols, nnz, <const void*>csc_col_offsets, <const void*>csc_row_ind, <const void*>csc_values, <_IndexType>csc_col_offsets_type, <_IndexType>csc_row_ind_type, <_IndexBase>idx_base, <DataType>value_type)
    check_status(__status__)
    return <intptr_t>sp_mat_descr
...
cpdef tuple csr_get(intptr_t sp_mat_descr):
    ...
    cdef DataType value_type
    with nogil:
        __status__ = cusparseCsrGet(<SpMatDescr>sp_mat_descr, &rows, &cols, &nnz, &csr_row_offsets, &csr_col_ind, &csr_values, &csr_row_offsets_type, &csr_col_ind_type, &idx_base, &value_type)
    check_status(__status__)
...
cpdef tuple const_csr_get(intptr_t sp_mat_descr):
    ...
    cdef DataType value_type
    with nogil:
        __status__ = cusparseConstCsrGet(<ConstSpMatDescr>sp_mat_descr, &rows, &cols, &nnz, &csr_row_offsets, &csr_col_ind, &csr_values, &csr_row_offsets_type, &csr_col_ind_type, &idx_base, &value_type)
    check_status(__status__)
    return (rows, cols, nnz, <intptr_t>csr_row_offsets, <intptr_t>csr_col_ind, <intptr_t>csr_values, <int>csr_row_offsets_type, <int>csr_col_ind_type, <int>idx_base, <int>value_type)
...
cpdef tuple csc_get(intptr_t sp_mat_descr):
    ...
    cdef DataType value_type
    with nogil:
        __status__ = cusparseCscGet(<SpMatDescr>sp_mat_descr, &rows, &cols, &nnz, &csc_col_offsets, &csc_row_ind, &csc_values, &csc_col_offsets_type, &csc_row_ind_type, &idx_base, &value_type)
    check_status(__status__)
...
cpdef tuple const_csc_get(intptr_t sp_mat_descr):
    ...
    cdef DataType value_type
    with nogil:
        __status__ = cusparseConstCscGet(<ConstSpMatDescr>sp_mat_descr, &rows, &cols, &nnz, &csc_col_offsets, &csc_row_ind, &csc_values, &csc_col_offsets_type, &csc_row_ind_type, &idx_base, &value_type)
    check_status(__status__)
    return (rows, cols, nnz, <intptr_t>csc_col_offsets, <intptr_t>csc_row_ind, <intptr_t>csc_values, <int>csc_col_offsets_type, <int>csc_row_ind_type, <int>idx_base, <int>value_type)
...
cpdef csr_set_pointers(intptr_t sp_mat_descr, intptr_t csr_row_offsets, intptr_t csr_col_ind, intptr_t csr_values):
    ...
    with nogil:
        __status__ = cusparseCsrSetPointers(<SpMatDescr>sp_mat_descr, <void*>csr_row_offsets, <void*>csr_col_ind, <void*>csr_values)
    check_status(__status__)
...
cpdef csc_set_pointers(intptr_t sp_mat_descr, intptr_t csc_col_offsets, intptr_t csc_row_ind, intptr_t csc_values):
    ...
    with nogil:
        __status__ = cusparseCscSetPointers(<SpMatDescr>sp_mat_descr, <void*>csc_col_offsets, <void*>csc_row_ind, <void*>csc_values)
    check_status(__status__)
...
cpdef intptr_t create_coo(int64_t rows, int64_t cols, int64_t nnz, intptr_t coo_row_ind, intptr_t coo_col_ind, intptr_t coo_values, int coo_idx_type, int idx_base, int value_type) except? 0:
    ...
    cdef SpMatDescr sp_mat_descr
    with nogil:
        __status__ = cusparseCreateCoo(&sp_mat_descr, rows, cols, nnz, <void*>coo_row_ind, <void*>coo_col_ind, <void*>coo_values, <_IndexType>coo_idx_type, <_IndexBase>idx_base, <DataType>value_type)
    check_status(__status__)
    return <intptr_t>sp_mat_descr
...
cpdef intptr_t create_const_coo(int64_t rows, int64_t cols, int64_t nnz, intptr_t coo_row_ind, intptr_t coo_col_ind, intptr_t coo_values, int coo_idx_type, int idx_base, int value_type) except? 0:
    ...
    cdef ConstSpMatDescr sp_mat_descr
    with nogil:
        __status__ = cusparseCreateConstCoo(&sp_mat_descr, rows, cols, nnz, <const void*>coo_row_ind, <const void*>coo_col_ind, <const void*>coo_values, <_IndexType>coo_idx_type, <_IndexBase>idx_base, <DataType>value_type)
    check_status(__status__)
    return <intptr_t>sp_mat_descr
...
cpdef tuple coo_get(intptr_t sp_mat_descr):
    ...
    cdef DataType value_type
    with nogil:
        __status__ = cusparseCooGet(<SpMatDescr>sp_mat_descr, &rows, &cols, &nnz, &coo_row_ind, &coo_col_ind, &coo_values, &idx_type, &idx_base, &value_type)
    check_status(__status__)
...
cpdef tuple const_coo_get(intptr_t sp_mat_descr):
    ...
    cdef DataType value_type
    with nogil:
        __status__ = cusparseConstCooGet(<ConstSpMatDescr>sp_mat_descr, &rows, &cols, &nnz, &coo_row_ind, &coo_col_ind, &coo_values, &idx_type, &idx_base, &value_type)
    check_status(__status__)
    return (rows, cols, nnz, <intptr_t>coo_row_ind, <intptr_t>coo_col_ind, <intptr_t>coo_values, <int>idx_type, <int>idx_base, <int>value_type)
...
cpdef coo_set_pointers(intptr_t sp_mat_descr, intptr_t coo_rows, intptr_t coo_columns, intptr_t coo_values):
    ...
    with nogil:
        __status__ = cusparseCooSetPointers(<SpMatDescr>sp_mat_descr, <void*>coo_rows, <void*>coo_columns, <void*>coo_values)
    check_status(__status__)
...
cpdef intptr_t create_blocked_ell(int64_t rows, int64_t cols, int64_t ell_block_size, int64_t ell_cols, intptr_t ell_col_ind, intptr_t ell_value, int ell_idx_type, int idx_base, int value_type) except? 0:
    ...
    cdef SpMatDescr sp_mat_descr
    with nogil:
        __status__ = cusparseCreateBlockedEll(&sp_mat_descr, rows, cols, ell_block_size, ell_cols, <void*>ell_col_ind, <void*>ell_value, <_IndexType>ell_idx_type, <_IndexBase>idx_base, <DataType>value_type)
    check_status(__status__)
    return <intptr_t>sp_mat_descr
...
cpdef intptr_t create_const_blocked_ell(int64_t rows, int64_t cols, int64_t ell_block_size, int64_t ell_cols, intptr_t ell_col_ind, intptr_t ell_value, int ell_idx_type, int idx_base, int value_type) except? 0:
    ...
    cdef ConstSpMatDescr sp_mat_descr
    with nogil:
        __status__ = cusparseCreateConstBlockedEll(&sp_mat_descr, rows, cols, ell_block_size, ell_cols, <const void*>ell_col_ind, <const void*>ell_value, <_IndexType>ell_idx_type, <_IndexBase>idx_base, <DataType>value_type)
    check_status(__status__)
    return <intptr_t>sp_mat_descr
...
cpdef tuple blocked_ell_get(intptr_t sp_mat_descr):
    ...
    cdef DataType value_type
    with nogil:
        __status__ = cusparseBlockedEllGet(<SpMatDescr>sp_mat_descr, &rows, &cols, &ell_block_size, &ell_cols, &ell_col_ind, &ell_value, &ell_idx_type, &idx_base, &value_type)
    check_status(__status__)
...
cpdef tuple const_blocked_ell_get(intptr_t sp_mat_descr):
    ...
    cdef DataType value_type
    with nogil:
        __status__ = cusparseConstBlockedEllGet(<ConstSpMatDescr>sp_mat_descr, &rows, &cols, &ell_block_size, &ell_cols, &ell_col_ind, &ell_value, &ell_idx_type, &idx_base, &value_type)
    check_status(__status__)
    return (rows, cols, ell_block_size, ell_cols, <intptr_t>ell_col_ind, <intptr_t>ell_value, <int>ell_idx_type, <int>idx_base, <int>value_type)
...
cpdef intptr_t create_dn_mat(int64_t rows, int64_t cols, int64_t ld, intptr_t values, int value_type, int order) except? 0:
    ...
    with nogil:
        __status__ = cusparseCreateDnMat(&dn_mat_descr, rows, cols, ld, <void*>values, <DataType>value_type, <_Order>order)
    check_status(__status__)
...
cpdef intptr_t create_const_dn_mat(int64_t rows, int64_t cols, int64_t ld, intptr_t values, int value_type, int order) except? 0:
    ...
    with nogil:
        __status__ = cusparseCreateConstDnMat(&dn_mat_descr, rows, cols, ld, <const void*>values, <DataType>value_type, <_Order>order)
    check_status(__status__)
    return <intptr_t>dn_mat_descr
...
cpdef destroy_dn_mat(intptr_t dn_mat_descr):
    ...
    with nogil:
        __status__ = cusparseDestroyDnMat(<ConstDnMatDescr>dn_mat_descr)
    check_status(__status__)
...
cpdef tuple dn_mat_get(intptr_t dn_mat_descr):
    ...
    cdef _Order order
    with nogil:
        __status__ = cusparseDnMatGet(<DnMatDescr>dn_mat_descr, &rows, &cols, &ld, &values, &type, &order)
    check_status(__status__)
...
cpdef tuple const_dn_mat_get(intptr_t dn_mat_descr):
    ...
    cdef _Order order
    with nogil:
        __status__ = cusparseConstDnMatGet(<ConstDnMatDescr>dn_mat_descr, &rows, &cols, &ld, &values, &type, &order)
    check_status(__status__)
    return (rows, cols, ld, <intptr_t>values, <int>type, <int>order)
...
cpdef intptr_t dn_mat_get_values(intptr_t dn_mat_descr) except? -1:
    ...
    cdef void* values
    with nogil:
        __status__ = cusparseDnMatGetValues(<DnMatDescr>dn_mat_descr, &values)
    check_status(__status__)
    return <intptr_t>values
...
cpdef intptr_t const_dn_mat_get_values(intptr_t dn_mat_descr) except? -1:
    ...
    cdef const void* values
    with nogil:
        __status__ = cusparseConstDnMatGetValues(<ConstDnMatDescr>dn_mat_descr, &values)
    check_status(__status__)
    return <intptr_t>values
...
cpdef dn_mat_set_values(intptr_t dn_mat_descr, intptr_t values):
    ...
    with nogil:
        __status__ = cusparseDnMatSetValues(<DnMatDescr>dn_mat_descr, <void*>values)
    check_status(__status__)
...
cpdef dn_mat_set_strided_batch(intptr_t dn_mat_descr, int batch_count, int64_t batch_stride):
    ...
    with nogil:
        __status__ = cusparseDnMatSetStridedBatch(<DnMatDescr>dn_mat_descr, batch_count, batch_stride)
    check_status(__status__)
...
cpdef tuple dn_mat_get_strided_batch(intptr_t dn_mat_descr):
    ...
    with nogil:
        __status__ = cusparseDnMatGetStridedBatch(<ConstDnMatDescr>dn_mat_descr, &batch_count, &batch_stride)
    check_status(__status__)
...
cpdef axpby(intptr_t handle, intptr_t alpha, intptr_t vec_x, intptr_t beta, intptr_t vec_y):
    """See `cusparseAxpby`."""
    with nogil:
        __status__ = cusparseAxpby(<Handle>handle, <const void*>alpha, <ConstSpVecDescr>vec_x, <const void*>beta, <DnVecDescr>vec_y)
    check_status(__status__)
...
cpdef gather(intptr_t handle, intptr_t vec_y, intptr_t vec_x):
    """See `cusparseGather`."""
    with nogil:
        __status__ = cusparseGather(<Handle>handle, <ConstDnVecDescr>vec_y, <SpVecDescr>vec_x)
    check_status(__status__)
...
cpdef size_t sp_vv_buffer_size(intptr_t handle, int op_x, intptr_t vec_x, intptr_t vec_y, intptr_t result, int compute_type) except? 0:
    ...
    cdef size_t buffer_size
    with nogil:
        __status__ = cusparseSpVV_bufferSize(<Handle>handle, <_Operation>op_x, <ConstSpVecDescr>vec_x, <ConstDnVecDescr>vec_y, <const void*>result, <DataType>compute_type, &buffer_size)
    check_status(__status__)
    return buffer_size
...
cpdef sp_vv(intptr_t handle, int op_x, intptr_t vec_x, intptr_t vec_y, intptr_t result, int compute_type, intptr_t external_buffer):
    """See `cusparseSpVV`."""
    with nogil:
        __status__ = cusparseSpVV(<Handle>handle, <_Operation>op_x, <ConstSpVecDescr>vec_x, <ConstDnVecDescr>vec_y, <void*>result, <DataType>compute_type, <void*>external_buffer)
    check_status(__status__)
...
cpdef size_t sparse_to_dense_buffer_size(intptr_t handle, intptr_t mat_a, intptr_t mat_b, int alg) except? 0:
    ...
    cdef size_t buffer_size
    with nogil:
        __status__ = cusparseSparseToDense_bufferSize(<Handle>handle, <ConstSpMatDescr>mat_a, <DnMatDescr>mat_b, <_SparseToDenseAlg>alg, &buffer_size)
    check_status(__status__)
    return buffer_size
...
cpdef sparse_to_dense(intptr_t handle, intptr_t mat_a, intptr_t mat_b, int alg, intptr_t external_buffer):
    ...
    with nogil:
        __status__ = cusparseSparseToDense(<Handle>handle, <ConstSpMatDescr>mat_a, <DnMatDescr>mat_b, <_SparseToDenseAlg>alg, <void*>external_buffer)
    check_status(__status__)
...
cpdef size_t dense_to_sparse_buffer_size(intptr_t handle, intptr_t mat_a, intptr_t mat_b, int alg) except? 0:
    ...
    cdef size_t buffer_size
    with nogil:
        __status__ = cusparseDenseToSparse_bufferSize(<Handle>handle, <ConstDnMatDescr>mat_a, <SpMatDescr>mat_b, <_DenseToSparseAlg>alg, &buffer_size)
    check_status(__status__)
    return buffer_size
...
cpdef dense_to_sparse_analysis(intptr_t handle, intptr_t mat_a, intptr_t mat_b, int alg, intptr_t external_buffer):
    ...
    with nogil:
        __status__ = cusparseDenseToSparse_analysis(<Handle>handle, <ConstDnMatDescr>mat_a, <SpMatDescr>mat_b, <_DenseToSparseAlg>alg, <void*>external_buffer)
    check_status(__status__)
...
cpdef dense_to_sparse_convert(intptr_t handle, intptr_t mat_a, intptr_t mat_b, int alg, intptr_t external_buffer):
    ...
    with nogil:
        __status__ = cusparseDenseToSparse_convert(<Handle>handle, <ConstDnMatDescr>mat_a, <SpMatDescr>mat_b, <_DenseToSparseAlg>alg, <void*>external_buffer)
    check_status(__status__)
...
cpdef sp_mv(intptr_t handle, int op_a, intptr_t alpha, intptr_t mat_a, intptr_t vec_x, intptr_t beta, intptr_t vec_y, int compute_type, int alg, intptr_t external_buffer):
    """See `cusparseSpMV`."""
    with nogil:
        __status__ = cusparseSpMV(<Handle>handle, <_Operation>op_a, <const void*>alpha, <ConstSpMatDescr>mat_a, <ConstDnVecDescr>vec_x, <const void*>beta, <DnVecDescr>vec_y, <DataType>compute_type, <_SpMVAlg>alg, <void*>external_buffer)
    check_status(__status__)
...
cpdef size_t sp_mv_buffer_size(intptr_t handle, int op_a, intptr_t alpha, intptr_t mat_a, intptr_t vec_x, intptr_t beta, intptr_t vec_y, int compute_type, int alg) except? 0:
    ...
    cdef size_t buffer_size
    with nogil:
        __status__ = cusparseSpMV_bufferSize(<Handle>handle, <_Operation>op_a, <const void*>alpha, <ConstSpMatDescr>mat_a, <ConstDnVecDescr>vec_x, <const void*>beta, <DnVecDescr>vec_y, <DataType>compute_type, <_SpMVAlg>alg, &buffer_size)
    check_status(__status__)
    return buffer_size
...
cpdef intptr_t sp_sv_create_descr() except? 0:
    ...
    with nogil:
        __status__ = cusparseSpSV_createDescr(&descr)
    check_status(__status__)
...
cpdef sp_sv_destroy_descr(intptr_t descr):
    ...
    with nogil:
        __status__ = cusparseSpSV_destroyDescr(<SpSVDescr>descr)
    check_status(__status__)
...
cpdef size_t sp_sv_buffer_size(intptr_t handle, int op_a, intptr_t alpha, intptr_t mat_a, intptr_t vec_x, intptr_t vec_y, int compute_type, int alg, intptr_t spsv_descr) except? 0:
    ...
    cdef size_t buffer_size
    with nogil:
        __status__ = cusparseSpSV_bufferSize(<Handle>handle, <_Operation>op_a, <const void*>alpha, <ConstSpMatDescr>mat_a, <ConstDnVecDescr>vec_x, <DnVecDescr>vec_y, <DataType>compute_type, <_SpSVAlg>alg, <SpSVDescr>spsv_descr, &buffer_size)
    check_status(__status__)
    return buffer_size
...
cpdef sp_sv_analysis(intptr_t handle, int op_a, intptr_t alpha, intptr_t mat_a, intptr_t vec_x, intptr_t vec_y, int compute_type, int alg, intptr_t spsv_descr, intptr_t external_buffer):
    ...
    with nogil:
        __status__ = cusparseSpSV_analysis(<Handle>handle, <_Operation>op_a, <const void*>alpha, <ConstSpMatDescr>mat_a, <ConstDnVecDescr>vec_x, <DnVecDescr>vec_y, <DataType>compute_type, <_SpSVAlg>alg, <SpSVDescr>spsv_descr, <void*>external_buffer)
    check_status(__status__)
...
cpdef sp_sv_solve(intptr_t handle, int op_a, intptr_t alpha, intptr_t mat_a, intptr_t vec_x, intptr_t vec_y, int compute_type, int alg, intptr_t spsv_descr):
    ...
    with nogil:
        __status__ = cusparseSpSV_solve(<Handle>handle, <_Operation>op_a, <const void*>alpha, <ConstSpMatDescr>mat_a, <ConstDnVecDescr>vec_x, <DnVecDescr>vec_y, <DataType>compute_type, <_SpSVAlg>alg, <SpSVDescr>spsv_descr)
    check_status(__status__)
...
cpdef intptr_t sp_sm_create_descr() except? 0:
    ...
    with nogil:
        __status__ = cusparseSpSM_createDescr(&descr)
    check_status(__status__)
    return <intptr_t>descr
...
cpdef sp_sm_destroy_descr(intptr_t descr):
    ...
    with nogil:
        __status__ = cusparseSpSM_destroyDescr(<SpSMDescr>descr)
    check_status(__status__)
...
cpdef size_t sp_sm_buffer_size(intptr_t handle, int op_a, int op_b, intptr_t alpha, intptr_t mat_a, intptr_t mat_b, intptr_t mat_c, int compute_type, int alg, intptr_t spsm_descr) except? 0:
    ...
    cdef size_t buffer_size
    with nogil:
        __status__ = cusparseSpSM_bufferSize(<Handle>handle, <_Operation>op_a, <_Operation>op_b, <const void*>alpha, <ConstSpMatDescr>mat_a, <ConstDnMatDescr>mat_b, <DnMatDescr>mat_c, <DataType>compute_type, <_SpSMAlg>alg, <SpSMDescr>spsm_descr, &buffer_size)
    check_status(__status__)
    return buffer_size
...
cpdef sp_sm_analysis(intptr_t handle, int op_a, int op_b, intptr_t alpha, intptr_t mat_a, intptr_t mat_b, intptr_t mat_c, int compute_type, int alg, intptr_t spsm_descr, intptr_t external_buffer):
    ...
    with nogil:
        __status__ = cusparseSpSM_analysis(<Handle>handle, <_Operation>op_a, <_Operation>op_b, <const void*>alpha, <ConstSpMatDescr>mat_a, <ConstDnMatDescr>mat_b, <DnMatDescr>mat_c, <DataType>compute_type, <_SpSMAlg>alg, <SpSMDescr>spsm_descr, <void*>external_buffer)
    check_status(__status__)
...
cpdef sp_sm_solve(intptr_t handle, int op_a, int op_b, intptr_t alpha, intptr_t mat_a, intptr_t mat_b, intptr_t mat_c, int compute_type, int alg, intptr_t spsm_descr):
    ...
    with nogil:
        __status__ = cusparseSpSM_solve(<Handle>handle, <_Operation>op_a, <_Operation>op_b, <const void*>alpha, <ConstSpMatDescr>mat_a, <ConstDnMatDescr>mat_b, <DnMatDescr>mat_c, <DataType>compute_type, <_SpSMAlg>alg, <SpSMDescr>spsm_descr)
    check_status(__status__)
...
cpdef size_t sp_mm_buffer_size(intptr_t handle, int op_a, int op_b, intptr_t alpha, intptr_t mat_a, intptr_t mat_b, intptr_t beta, intptr_t mat_c, int compute_type, int alg) except? 0:
    ...
    cdef size_t buffer_size
    with nogil:
        __status__ = cusparseSpMM_bufferSize(<Handle>handle, <_Operation>op_a, <_Operation>op_b, <const void*>alpha, <ConstSpMatDescr>mat_a, <ConstDnMatDescr>mat_b, <const void*>beta, <DnMatDescr>mat_c, <DataType>compute_type, <_SpMMAlg>alg, &buffer_size)
    check_status(__status__)
    return buffer_size
...
cpdef sp_mm_preprocess(intptr_t handle, int op_a, int op_b, intptr_t alpha, intptr_t mat_a, intptr_t mat_b, intptr_t beta, intptr_t mat_c, int compute_type, int alg, intptr_t external_buffer):
    ...
    with nogil:
        __status__ = cusparseSpMM_preprocess(<Handle>handle, <_Operation>op_a, <_Operation>op_b, <const void*>alpha, <ConstSpMatDescr>mat_a, <ConstDnMatDescr>mat_b, <const void*>beta, <DnMatDescr>mat_c, <DataType>compute_type, <_SpMMAlg>alg, <void*>external_buffer)
    check_status(__status__)
...
cpdef sp_mm(intptr_t handle, int op_a, int op_b, intptr_t alpha, intptr_t mat_a, intptr_t mat_b, intptr_t beta, intptr_t mat_c, int compute_type, int alg, intptr_t external_buffer):
    """See `cusparseSpMM`."""
    with nogil:
        __status__ = cusparseSpMM(<Handle>handle, <_Operation>op_a, <_Operation>op_b, <const void*>alpha, <ConstSpMatDescr>mat_a, <ConstDnMatDescr>mat_b, <const void*>beta, <DnMatDescr>mat_c, <DataType>compute_type, <_SpMMAlg>alg, <void*>external_buffer)
    check_status(__status__)
...
cpdef intptr_t sp_gemm_create_descr() except? 0:
    ...
    with nogil:
        __status__ = cusparseSpGEMM_createDescr(&descr)
    check_status(__status__)
    return <intptr_t>descr
...
cpdef sp_gemm_destroy_descr(intptr_t descr):
    ...
    with nogil:
        __status__ = cusparseSpGEMM_destroyDescr(<SpGEMMDescr>descr)
    check_status(__status__)
...
cpdef size_t sp_gemm_work_estimation(intptr_t handle, int op_a, int op_b, intptr_t alpha, intptr_t mat_a, intptr_t mat_b, intptr_t beta, intptr_t mat_c, int compute_type, int alg, intptr_t spgemm_descr, intptr_t external_buffer1) except? 0:
    ...
    with nogil:
        __status__ = cusparseSpGEMM_workEstimation(<Handle>handle, <_Operation>op_a, <_Operation>op_b, <const void*>alpha, <ConstSpMatDescr>mat_a, <ConstSpMatDescr>mat_b, <const void*>beta, <SpMatDescr>mat_c, <DataType>compute_type, <_SpGEMMAlg>alg, <SpGEMMDescr>spgemm_descr, &buffer_size1, <void*>external_buffer1)
    check_status(__status__)
    return buffer_size1
...
cpdef int64_t sp_gemm_get_num_products(intptr_t spgemm_descr) except? -1:
    ...
    with nogil:
        __status__ = cusparseSpGEMM_getNumProducts(<SpGEMMDescr>spgemm_descr, &num_prods)
    check_status(__status__)
    return num_prods
...
cpdef sp_gemm_compute(intptr_t handle, int op_a, int op_b, intptr_t alpha, intptr_t mat_a, intptr_t mat_b, intptr_t beta, intptr_t mat_c, int compute_type, int alg, intptr_t spgemm_descr, intptr_t buffer_size2, intptr_t external_buffer2):
    ...
    with nogil:
        __status__ = cusparseSpGEMM_compute(<Handle>handle, <_Operation>op_a, <_Operation>op_b, <const void*>alpha, <ConstSpMatDescr>mat_a, <ConstSpMatDescr>mat_b, <const void*>beta, <SpMatDescr>mat_c, <DataType>compute_type, <_SpGEMMAlg>alg, <SpGEMMDescr>spgemm_descr, <size_t*>buffer_size2, <void*>external_buffer2)
    check_status(__status__)
...
cpdef sp_gemm_copy(intptr_t handle, int op_a, int op_b, intptr_t alpha, intptr_t mat_a, intptr_t mat_b, intptr_t beta, intptr_t mat_c, int compute_type, int alg, intptr_t spgemm_descr):
    ...
    with nogil:
        __status__ = cusparseSpGEMM_copy(<Handle>handle, <_Operation>op_a, <_Operation>op_b, <const void*>alpha, <ConstSpMatDescr>mat_a, <ConstSpMatDescr>mat_b, <const void*>beta, <SpMatDescr>mat_c, <DataType>compute_type, <_SpGEMMAlg>alg, <SpGEMMDescr>spgemm_descr)
    check_status(__status__)
...
cpdef size_t sp_gemm_reuse_work_estimation(intptr_t handle, int op_a, int op_b, intptr_t mat_a, intptr_t mat_b, intptr_t mat_c, int alg, intptr_t spgemm_descr, intptr_t external_buffer1) except? 0:
    ...
    cdef size_t buffer_size1
    with nogil:
        __status__ = cusparseSpGEMMreuse_workEstimation(<Handle>handle, <_Operation>op_a, <_Operation>op_b, <ConstSpMatDescr>mat_a, <ConstSpMatDescr>mat_b, <SpMatDescr>mat_c, <_SpGEMMAlg>alg, <SpGEMMDescr>spgemm_descr, &buffer_size1, <void*>external_buffer1)
    check_status(__status__)
    return buffer_size1
...
cpdef tuple sp_gemm_reuse_nnz(intptr_t handle, int op_a, int op_b, intptr_t mat_a, intptr_t mat_b, intptr_t mat_c, int alg, intptr_t spgemm_descr, intptr_t external_buffer2, intptr_t external_buffer3, intptr_t external_buffer4):
    ...
    with nogil:
        __status__ = cusparseSpGEMMreuse_nnz(<Handle>handle, <_Operation>op_a, <_Operation>op_b, <ConstSpMatDescr>mat_a, <ConstSpMatDescr>mat_b, <SpMatDescr>mat_c, <_SpGEMMAlg>alg, <SpGEMMDescr>spgemm_descr, &buffer_size2, <void*>external_buffer2, &buffer_size3, <void*>external_buffer3, &buffer_size4, <void*>external_buffer4)
    check_status(__status__)
...
cpdef size_t sp_gemm_reuse_copy(intptr_t handle, int op_a, int op_b, intptr_t mat_a, intptr_t mat_b, intptr_t mat_c, int alg, intptr_t spgemm_descr, intptr_t external_buffer5) except? 0:
    ...
    with nogil:
        __status__ = cusparseSpGEMMreuse_copy(<Handle>handle, <_Operation>op_a, <_Operation>op_b, <ConstSpMatDescr>mat_a, <ConstSpMatDescr>mat_b, <SpMatDescr>mat_c, <_SpGEMMAlg>alg, <SpGEMMDescr>spgemm_descr, &buffer_size5, <void*>external_buffer5)
    check_status(__status__)
    return buffer_size5
...
cpdef sp_gemm_reuse_compute(intptr_t handle, int op_a, int op_b, intptr_t alpha, intptr_t mat_a, intptr_t mat_b, intptr_t beta, intptr_t mat_c, int compute_type, int alg, intptr_t spgemm_descr):
    ...
    with nogil:
        __status__ = cusparseSpGEMMreuse_compute(<Handle>handle, <_Operation>op_a, <_Operation>op_b, <const void*>alpha, <ConstSpMatDescr>mat_a, <ConstSpMatDescr>mat_b, <const void*>beta, <SpMatDescr>mat_c, <DataType>compute_type, <_SpGEMMAlg>alg, <SpGEMMDescr>spgemm_descr)
    check_status(__status__)
...
cpdef sddmm_buffer_size(intptr_t handle, int op_a, int op_b, intptr_t alpha, intptr_t mat_a, intptr_t mat_b, intptr_t beta, intptr_t mat_c, int compute_type, int alg, intptr_t buffer_size):
    ...
    with nogil:
        __status__ = cusparseSDDMM_bufferSize(<Handle>handle, <_Operation>op_a, <_Operation>op_b, <const void*>alpha, <ConstDnMatDescr>mat_a, <ConstDnMatDescr>mat_b, <const void*>beta, <SpMatDescr>mat_c, <DataType>compute_type, <_SDDMMAlg>alg, <size_t*>buffer_size)
    check_status(__status__)
...
cpdef sddmm_preprocess(intptr_t handle, int op_a, int op_b, intptr_t alpha, intptr_t mat_a, intptr_t mat_b, intptr_t beta, intptr_t mat_c, int compute_type, int alg, intptr_t external_buffer):
    ...
    with nogil:
        __status__ = cusparseSDDMM_preprocess(<Handle>handle, <_Operation>op_a, <_Operation>op_b, <const void*>alpha, <ConstDnMatDescr>mat_a, <ConstDnMatDescr>mat_b, <const void*>beta, <SpMatDescr>mat_c, <DataType>compute_type, <_SDDMMAlg>alg, <void*>external_buffer)
    check_status(__status__)
...
cpdef sddmm(intptr_t handle, int op_a, int op_b, intptr_t alpha, intptr_t mat_a, intptr_t mat_b, intptr_t beta, intptr_t mat_c, int compute_type, int alg, intptr_t external_buffer):
    """See `cusparseSDDMM`."""
    with nogil:
        __status__ = cusparseSDDMM(<Handle>handle, <_Operation>op_a, <_Operation>op_b, <const void*>alpha, <ConstDnMatDescr>mat_a, <ConstDnMatDescr>mat_b, <const void*>beta, <SpMatDescr>mat_c, <DataType>compute_type, <_SDDMMAlg>alg, <void*>external_buffer)
    check_status(__status__)
...
cpdef tuple sp_mm_op_create_plan(intptr_t handle, int op_a, int op_b, intptr_t mat_a, intptr_t mat_b, intptr_t mat_c, int compute_type, int alg, intptr_t add_operation_ltoir_buffer, size_t add_operation_buffer_size, intptr_t mul_operation_ltoir_buffer, size_t mul_operation_buffer_size, intptr_t epilogue_ltoir_buffer, size_t epilogue_buffer_size):
    ...
    with nogil:
        __status__ = cusparseSpMMOp_createPlan(<Handle>handle, &plan, <_Operation>op_a, <_Operation>op_b, <ConstSpMatDescr>mat_a, <ConstDnMatDescr>mat_b, <DnMatDescr>mat_c, <DataType>compute_type, <_SpMMOpAlg>alg, <const void*>add_operation_ltoir_buffer, add_operation_buffer_size, <const void*>mul_operation_ltoir_buffer, mul_operation_buffer_size, <const void*>epilogue_ltoir_buffer, epilogue_buffer_size, &sp_mm_workspace_size)
    check_status(__status__)
...
cpdef sp_mm_op(intptr_t plan, intptr_t external_buffer):
    """See `cusparseSpMMOp`."""
    with nogil:
        __status__ = cusparseSpMMOp(<SpMMOpPlan>plan, <void*>external_buffer)
    check_status(__status__)
...
cpdef sp_mm_op_destroy_plan(intptr_t plan):
    ...
    with nogil:
        __status__ = cusparseSpMMOp_destroyPlan(<SpMMOpPlan>plan)
    check_status(__status__)
...
cpdef bsr_set_strided_batch(intptr_t sp_mat_descr, int batch_count, int64_t offsets_batch_stride, int64_t columns_batch_stride, int64_t values_batch_stride):
    ...
    with nogil:
        __status__ = cusparseBsrSetStridedBatch(<SpMatDescr>sp_mat_descr, batch_count, offsets_batch_stride, columns_batch_stride, values_batch_stride)
    check_status(__status__)
...
cpdef intptr_t create_bsr(int64_t brows, int64_t bcols, int64_t bnnz, int64_t row_block_size, int64_t col_block_size, intptr_t bsr_row_offsets, intptr_t bsr_col_ind, intptr_t bsr_values, int bsr_row_offsets_type, int bsr_col_ind_type, int idx_base, int value_type, int order) except? 0:
    ...
    cdef SpMatDescr sp_mat_descr
    with nogil:
        __status__ = cusparseCreateBsr(&sp_mat_descr, brows, bcols, bnnz, row_block_size, col_block_size, <void*>bsr_row_offsets, <void*>bsr_col_ind, <void*>bsr_values, <_IndexType>bsr_row_offsets_type, <_IndexType>bsr_col_ind_type, <_IndexBase>idx_base, <DataType>value_type, <_Order>order)
    check_status(__status__)
    return <intptr_t>sp_mat_descr
...
cpdef intptr_t create_const_bsr(int64_t brows, int64_t bcols, int64_t bnnz, int64_t row_block_dim, int64_t col_block_dim, intptr_t bsr_row_offsets, intptr_t bsr_col_ind, intptr_t bsr_values, int bsr_row_offsets_type, int bsr_col_ind_type, int idx_base, int value_type, int order) except? 0:
    ...
    cdef ConstSpMatDescr sp_mat_descr
    with nogil:
        __status__ = cusparseCreateConstBsr(&sp_mat_descr, brows, bcols, bnnz, row_block_dim, col_block_dim, <const void*>bsr_row_offsets, <const void*>bsr_col_ind, <const void*>bsr_values, <_IndexType>bsr_row_offsets_type, <_IndexType>bsr_col_ind_type, <_IndexBase>idx_base, <DataType>value_type, <_Order>order)
    check_status(__status__)
    return <intptr_t>sp_mat_descr
...
cpdef intptr_t create_sliced_ell(int64_t rows, int64_t cols, int64_t nnz, int64_t sell_values_size, int64_t slice_size, intptr_t sell_slice_offsets, intptr_t sell_col_ind, intptr_t sell_values, int sell_slice_offsets_type, int sell_col_ind_type, int idx_base, int value_type) except? 0:
    ...
    cdef SpMatDescr sp_mat_descr
    with nogil:
        __status__ = cusparseCreateSlicedEll(&sp_mat_descr, rows, cols, nnz, sell_values_size, slice_size, <void*>sell_slice_offsets, <void*>sell_col_ind, <void*>sell_values, <_IndexType>sell_slice_offsets_type, <_IndexType>sell_col_ind_type, <_IndexBase>idx_base, <DataType>value_type)
    check_status(__status__)
    return <intptr_t>sp_mat_descr
...
cpdef intptr_t create_const_sliced_ell(int64_t rows, int64_t cols, int64_t nnz, int64_t sell_values_size, int64_t slice_size, intptr_t sell_slice_offsets, intptr_t sell_col_ind, intptr_t sell_values, int sell_slice_offsets_type, int sell_col_ind_type, int idx_base, int value_type) except? 0:
    ...
    cdef ConstSpMatDescr sp_mat_descr
    with nogil:
        __status__ = cusparseCreateConstSlicedEll(&sp_mat_descr, rows, cols, nnz, sell_values_size, slice_size, <const void*>sell_slice_offsets, <const void*>sell_col_ind, <const void*>sell_values, <_IndexType>sell_slice_offsets_type, <_IndexType>sell_col_ind_type, <_IndexBase>idx_base, <DataType>value_type)
    check_status(__status__)
    return <intptr_t>sp_mat_descr
...
cpdef sp_sv_update_matrix(intptr_t handle, intptr_t spsv_descr, intptr_t new_values, int update_part):
    ...
    with nogil:
        __status__ = cusparseSpSV_updateMatrix(<Handle>handle, <SpSVDescr>spsv_descr, <void*>new_values, <_SpSVUpdate>update_part)
    check_status(__status__)
...
cpdef sp_mv_preprocess(intptr_t handle, int op_a, intptr_t alpha, intptr_t mat_a, intptr_t vec_x, intptr_t beta, intptr_t vec_y, int compute_type, int alg, intptr_t external_buffer):
    ...
    with nogil:
        __status__ = cusparseSpMV_preprocess(<Handle>handle, <_Operation>op_a, <const void*>alpha, <ConstSpMatDescr>mat_a, <ConstDnVecDescr>vec_x, <const void*>beta, <DnVecDescr>vec_y, <DataType>compute_type, <_SpMVAlg>alg, <void*>external_buffer)
    check_status(__status__)
