...
disable_cpu_instructions_set_mask: _cython_3_2_5.cython_function_or_method
emulation_desc_create: _cython_3_2_5.cython_function_or_method
emulation_desc_destroy: _cython_3_2_5.cython_function_or_method
emulation_desc_get_attribute: _cython_3_2_5.cython_function_or_method
emulation_desc_set_attribute: _cython_3_2_5.cython_function_or_method
get_cudart_version: _cython_3_2_5.cython_function_or_method
get_emulation_desc_attribute_dtype: _cython_3_2_5.cython_function_or_method
get_matmul_algo_cap_attribute_dtype: _cython_3_2_5.cython_function_or_method
get_matmul_algo_config_attribute_dtype: _cython_3_2_5.cython_function_or_method
get_matmul_desc_attribute_dtype: _cython_3_2_5.cython_function_or_method
get_matmul_preference_attribute_dtype: _cython_3_2_5.cython_function_or_method
get_matrix_layout_attribute_dtype: _cython_3_2_5.cython_function_or_method
get_matrix_transform_desc_attribute_dtype: _cython_3_2_5.cython_function_or_method
...
grouped_matrix_layout_create: _cython_3_2_5.cython_function_or_method
heuristics_cache_get_capacity: _cython_3_2_5.cython_function_or_method
heuristics_cache_set_capacity: _cython_3_2_5.cython_function_or_method
...
matmul_algo_cap_get_attribute: _cython_3_2_5.cython_function_or_method
matmul_algo_check: _cython_3_2_5.cython_function_or_method
matmul_algo_config_get_attribute: _cython_3_2_5.cython_function_or_method
matmul_algo_config_set_attribute: _cython_3_2_5.cython_function_or_method
matmul_algo_dtype: numpy.dtypes.VoidDType
matmul_algo_get_heuristic: _cython_3_2_5.cython_function_or_method
matmul_algo_get_ids: _cython_3_2_5.cython_function_or_method
matmul_algo_init: _cython_3_2_5.cython_function_or_method
matmul_desc_create: _cython_3_2_5.cython_function_or_method
matmul_desc_destroy: _cython_3_2_5.cython_function_or_method
matmul_desc_get_attribute: _cython_3_2_5.cython_function_or_method
matmul_desc_set_attribute: _cython_3_2_5.cython_function_or_method
matmul_heuristic_result_dtype: numpy.dtypes.VoidDType
matmul_preference_create: _cython_3_2_5.cython_function_or_method
matmul_preference_destroy: _cython_3_2_5.cython_function_or_method
matmul_preference_get_attribute: _cython_3_2_5.cython_function_or_method
matmul_preference_set_attribute: _cython_3_2_5.cython_function_or_method
matrix_layout_create: _cython_3_2_5.cython_function_or_method
matrix_layout_destroy: _cython_3_2_5.cython_function_or_method
matrix_layout_get_attribute: _cython_3_2_5.cython_function_or_method
matrix_layout_set_attribute: _cython_3_2_5.cython_function_or_method
matrix_transform: _cython_3_2_5.cython_function_or_method
matrix_transform_desc_create: _cython_3_2_5.cython_function_or_method
matrix_transform_desc_destroy: _cython_3_2_5.cython_function_or_method
matrix_transform_desc_get_attribute: _cython_3_2_5.cython_function_or_method
matrix_transform_desc_set_attribute: _cython_3_2_5.cython_function_or_method
...
class EmulationDescAttribute(enum.IntEnum):
    """
    See `cublasLtEmulationDescAttributes_t`.
    """
    __new__: ClassVar[Callable] = ...
    FIXEDPOINT_MANTISSA_BIT_COUNT_POINTER: ClassVar[EmulationDescAttribute] = ...
    FIXEDPOINT_MANTISSA_BIT_OFFSET: ClassVar[EmulationDescAttribute] = ...
    FIXEDPOINT_MANTISSA_CONTROL: ClassVar[EmulationDescAttribute] = ...
    FIXEDPOINT_MAX_MANTISSA_BIT_COUNT: ClassVar[EmulationDescAttribute] = ...
    SPECIAL_VALUES_SUPPORT: ClassVar[EmulationDescAttribute] = ...
    STRATEGY: ClassVar[EmulationDescAttribute] = ...
    _generate_next_value_: ClassVar[Callable] = ...
    _hashable_values_: ClassVar[list] = ...
    _member_map_: ClassVar[dict] = ...
    _member_names_: ClassVar[list] = ...
...
class IntegerWidth(enum.IntEnum):
    """
    See `cublasLtIntegerWidth_t`.
    """
    __new__: ClassVar[Callable] = ...
    WIDTH_32: ClassVar[IntegerWidth] = ...
    WIDTH_64: ClassVar[IntegerWidth] = ...
    _generate_next_value_: ClassVar[Callable] = ...
    _hashable_values_: ClassVar[list] = ...
    _member_map_: ClassVar[dict] = ...
    _member_names_: ClassVar[list] = ...
...
class MatmulAlgo:
    ...
    @staticmethod
    def from_buffer(buffer) -> Any:
        """MatmulAlgo.from_buffer(buffer)
...
class MatmulAlgoCapAttribute(enum.IntEnum):
    ...
    POINTER_ARRAY_GROUPED_SUPPORT: ClassVar[MatmulAlgoCapAttribute] = ...
...
class MatmulDescAttribute(enum.IntEnum):
    ...
    """
    __new__: ClassVar[Callable] = ...
    ALPHA_BATCH_STRIDE: ClassVar[MatmulDescAttribute] = ...
    ...
    BETA_BATCH_STRIDE: ClassVar[MatmulDescAttribute] = ...
    ...
    EMULATION_DESCRIPTOR: ClassVar[MatmulDescAttribute] = ...
...
class MatmulHeuristicResult:
    ...
    @staticmethod
    def from_buffer(buffer) -> Any:
        """MatmulHeuristicResult.from_buffer(buffer)
...
class MatmulMatrixScale(enum.IntEnum):
    ...
    PER_BATCH_SCALAR_32F: ClassVar[MatmulMatrixScale] = ...
...
class MatmulPreferenceAttribute(enum.IntEnum):
    ...
    GROUPED_AVERAGE_REDUCTION_DIM: ClassVar[MatmulPreferenceAttribute] = ...
    GROUPED_DESC_D_AVERAGE_COLS: ClassVar[MatmulPreferenceAttribute] = ...
    GROUPED_DESC_D_AVERAGE_ROWS: ClassVar[MatmulPreferenceAttribute] = ...
...
class MatmulStages(enum.IntEnum):
    ...
    STAGES_768xAUTO: ClassVar[MatmulStages] = ...
...
class MatrixLayoutAttribute(enum.IntEnum):
    ...
    GROUPED_COLS_ARRAY: ClassVar[MatrixLayoutAttribute] = ...
    GROUPED_LD_ARRAY: ClassVar[MatrixLayoutAttribute] = ...
    GROUPED_LD_ARRAY_INTEGER_WIDTH: ClassVar[MatrixLayoutAttribute] = ...
    GROUPED_ROWS_ARRAY: ClassVar[MatrixLayoutAttribute] = ...
    GROUPED_ROWS_COLS_ARRAY_INTEGER_WIDTH: ClassVar[MatrixLayoutAttribute] = ...
