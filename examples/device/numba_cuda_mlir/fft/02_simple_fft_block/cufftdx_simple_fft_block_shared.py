...
#
# Mirrors https://github.com/NVIDIA/CUDALibrarySamples/blob/main/MathDx/cuFFTDx/02_simple_fft_block/simple_fft_block_shared.cu
#
...
def main():
    ...
    assert error < 1e-5, f"Error {error} is too large"
