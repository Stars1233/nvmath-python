...
#
# Mirrors https://github.com/NVIDIA/CUDALibrarySamples/blob/main/MathDx/cuSolverDx/01_Linear_Solve/gesv_batched_wo_pivot_block.cu
#
...
def main():
    ...
    error_sum = 0.0
    for sample_idx in range(batch_count):
        x_scipy = scipy.linalg.solve(a[sample_idx].conj().T, b[sample_idx])
