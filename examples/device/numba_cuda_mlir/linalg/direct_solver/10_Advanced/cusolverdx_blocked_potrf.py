...
#
# Mirrors https://github.com/NVIDIA/CUDALibrarySamples/blob/main/MathDx/cuSolverDx/10_Advanced/blocked_potrf.cu
#
...
from common import prepare_random_matrix, verify_triangular_relative_error  # type: ignore[misc, import-not-found]
from common_numba import time_simt_prep_args as time_simt  # type: ignore[misc, import-not-found]
...
def main():
    ...
    def kernel(a, info):
        ...
        sinfo = smem[4 * block_size :].view(np.int32)[0:1]
    ...
    ms = time_simt(kernel, BATCH_COUNT, NT, SMEM_SIZE, REPEATS, prep_args)
