...
#
# Mirrors https://github.com/NVIDIA/CUDALibrarySamples/blob/main/MathDx/cuSolverDx/03_Orthogonal_Factors/unmqr_batched_block.cu
#
...
def reconstruct_qr(factorizer: QRFactorize, a: np.ndarray, tau: np.ndarray) -> tuple[np.ndarray, np.ndarray]:
    r = np.triu(a)
