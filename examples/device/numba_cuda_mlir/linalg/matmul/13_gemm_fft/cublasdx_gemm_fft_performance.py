...
from common_numba import load_to_shared, time_simt  # type: ignore[misc, import-not-found]
...
def main():
    ...
    time_nb = time_simt(kernel, grid_dim, block_dim, shared_memory_size, ncycles, a, b, c, alpha, beta, data_test)
