...
#
# Mirrors https://github.com/NVIDIA/CUDALibrarySamples/blob/main/MathDx/cuFFTDx/01_simple_fft_thread/simple_fft_thread.cu
#
...
def main():
    ...
    data = np.zeros((threads_count, fft.size), dtype=np.complex128)
