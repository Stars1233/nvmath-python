...
#
# Mirrors https://github.com/NVIDIA/CUDALibrarySamples/blob/main/MathDx/cuFFTDx/06_convolution/convolution_r2c_c2r.cu
#
...
def main():
    ...
    data = np.empty((ffts_per_block, fft_size), dtype=np.float32)
    for i in range(ffts_per_block * fft_size):
        data.flat[i] = float(i)
