...
"""
This example illustrates the use of the global Python logger with redistribute.
...
# The global 3-D problem size is (64, 256, 128), initially partitioned on the X axis
# across processes.
X, Y, Z = (64, 256, 128)
...
# Redistribute the operand so that it is partitioned on the Y axis.
b = nvmath.distributed.distribution.redistribute(a, Slab.X, Slab.Y)
