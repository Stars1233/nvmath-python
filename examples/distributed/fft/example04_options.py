...
# the same distribution for the result, by redistributing to the original distribution
# (see the documentation for the redistribute option in distributed FFTOptions).
...
# redistribution operations (which incur GPU-GPU communication overhead), we will use
# the redistribute=False option.

# Alternative #1 for specifying options, using dataclass.
options = nvmath.distributed.fft.FFTOptions(redistribute=False)
